...
public class TableFinder implements IntoTableVisitor, SelectVisitor, SelectItemVisitor, FromItemVisitor, ExpressionVisitor,
		ItemsListVisitor {
	final private Set<String> tables=new TreeSet<String>();
