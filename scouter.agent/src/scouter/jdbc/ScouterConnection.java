...
public class ScouterConnection implements java.sql.Connection {
    ...
    final public java.sql.PreparedStatement prepareStatement(java.lang.String a0,int a1,int a2) throws java.sql.SQLException{
        return new ScouterPreparedStatement(this.inner.prepareStatement(a0, a1, a2),a0);
    }
    final public java.sql.PreparedStatement prepareStatement(java.lang.String a0,int a1,int a2,int a3) throws java.sql.SQLException{
        return new ScouterPreparedStatement(this.inner.prepareStatement(a0, a1, a2, a3),a0);
    }
    final public java.sql.PreparedStatement prepareStatement(java.lang.String a0,int[] a1) throws java.sql.SQLException{
        return new ScouterPreparedStatement(this.inner.prepareStatement(a0, a1),a0);
    }
    final public java.sql.PreparedStatement prepareStatement(java.lang.String a0,java.lang.String[] a1) throws java.sql.SQLException{
        return new ScouterPreparedStatement(this.inner.prepareStatement(a0, a1),a0);
    }
    ...
    final public java.sql.CallableStatement prepareCall(java.lang.String a0,int a1,int a2) throws java.sql.SQLException{
        return new ScouterCallableStatement(this.inner.prepareCall(a0, a1, a2),a0);
    }
    final public java.sql.CallableStatement prepareCall(java.lang.String a0,int a1,int a2,int a3) throws java.sql.SQLException{
    ...
    final public void setTypeMap(java.util.Map a0) throws java.sql.SQLException{
