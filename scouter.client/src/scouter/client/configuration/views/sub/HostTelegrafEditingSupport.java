 ...
 */
public class HostTelegrafEditingSupport extends EditingSupport {

    private final TableViewer viewer;
    private final CellEditor editor;

    public HostTelegrafEditingSupport(TableViewer viewer) {
        super(viewer);
        this.viewer = viewer;
    ...
    protected void setValue(Object element, Object userInputValue) {
        ((TgmConfig.HostMapping) element).telegraf = String.valueOf(userInputValue);
