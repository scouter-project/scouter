 ...
 */
public class SingleColumnEditingSupport extends EditingSupport {

    private final TableViewer viewer;
    private final CellEditor editor;

    public SingleColumnEditingSupport(TableViewer viewer) {
        super(viewer);
        this.viewer = viewer;
    ...
    protected void setValue(Object element, Object userInputValue) {
        ((SingleString) element).value = String.valueOf(userInputValue);
