 ...
 */
public class TagMappingTagEditingSupport extends EditingSupport {

    private final TableViewer viewer;
    private final CellEditor editor;

    public TagMappingTagEditingSupport(TableViewer viewer) {
        super(viewer);
        this.viewer = viewer;
    ...
    protected void setValue(Object element, Object userInputValue) {
        ((TagFilterMapping) element).tag = String.valueOf(userInputValue);
