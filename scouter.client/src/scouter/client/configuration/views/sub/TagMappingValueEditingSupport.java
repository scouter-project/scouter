 ...
 */
public class TagMappingValueEditingSupport extends EditingSupport {

    private final TableViewer viewer;
    private final CellEditor editor;

    public TagMappingValueEditingSupport(TableViewer viewer) {
        super(viewer);
        this.viewer = viewer;
    ...
    protected void setValue(Object element, Object userInputValue) {
        ((TagFilterMapping) element).mappingValue = String.valueOf(userInputValue);
