...
public class CountersSiteFileConfigView extends ViewPart {

    private int serverId;
    public static final String ID = "scouter.client.configuration.views.CountersSiteFileConfigView"; //$NON-NLS-1$
    ...
    public CountersSiteFileConfigView() {}
    ...
    private void loadConfig() {
        ExUtil.asyncRun(new Runnable() {
            public void run() {
                ...
                try {
                    mpack = (MapPack) tcp.getSingle(RequestCmd.GET_CONFIGURE_COUNTERS_SITE, null);
                } finally {
                    TcpProxy.putTcpProxy(tcp);
                }
                if (mpack != null) {
                    m_tgConfigContents = mpack.getText("contents");
                }
    ...
    private void saveConfig() {
        ...
        try {
            ...
            MapPack out = (MapPack) tcp.getSingle(RequestCmd.SET_CONFIGURE_COUNTERS_SITE, param);
