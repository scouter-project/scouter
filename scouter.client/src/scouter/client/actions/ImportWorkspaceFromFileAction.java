...
public class ImportWorkspaceFromFileAction extends Action {
	public final static String ID = ImportWorkspaceFromFileAction.class.getName();

	private final IWorkbenchWindow window;

	public ImportWorkspaceFromFileAction(IWorkbenchWindow window, String label, Image image) {
		this.window = window;
		setText(label);
		setId(ID);
