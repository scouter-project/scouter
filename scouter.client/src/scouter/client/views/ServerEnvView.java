...
public class ServerEnvView extends ViewPart {
	public static final String ID = ServerEnvView.class.getName();
...
private Text filterTxt;
	...
	public void createPartControl(Composite parent) {
		this.setPartName(ServerManager.getInstance().getServer(serverId).getName());
		this.parent = parent;
		initialLayout();
	...
	private void load() {
		ExUtil.asyncRun(new Runnable() {
			public void run() {
				MapPack pack = ServerDataProxy.getEnv(serverId);
				if (pack != null) {
