...
public class ServerThreadListView extends ViewPart implements ViewWithTable{
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseDoubleClick(MouseEvent e) {
				...
				try {
					...
					ServerThreadDetailView view = (ServerThreadDetailView) win.getActivePage().showView(ServerThreadDetailView.ID, "" + threadId, IWorkbenchPage.VIEW_ACTIVATE);
					view.setInput("[" + threadId + "]", threadId, serverId);
				} catch (Exception d) {
				}
			}
		});
