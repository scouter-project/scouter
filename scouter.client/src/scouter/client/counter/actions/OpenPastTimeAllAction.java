...
public class OpenPastTimeAllAction extends Action {
	public final static String ID = OpenPastTimeAllAction.class.getName();
	...
	public OpenPastTimeAllAction(IWorkbenchWindow window, String label, String objType, String counter, Image image, long startTime, long endTime, int serverId) {
		this.window = window;
