...
public class OpenPastLongDateAllAction extends Action /*implements LoadDualCalendarDialog.ILoadDualCounterDialog*/ {
	public final static String ID = OpenPastLongDateAllAction.class.getName();
