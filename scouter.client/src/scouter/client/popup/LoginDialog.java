...
public class LoginDialog {
	...
	public void show() {
		...
		shell.setImage(Activator.getImage("icons/h16.png"));
...
//		Text aboutLabel = new Text(shell, SWT.BORDER | SWT.READ_ONLY | SWT.WRAP | SWT.V_SCROLL | SWT.H_SCROLL);
//		aboutLabel.setLayoutData(UIUtil.formData(0, 5, footer, 10, 100, -5, null, -1, 100, 70));
