...
public class ProfileDataController {
    ...
    @GET
    @Path("/{yyyymmdd}/{txid}")
    public CommonResultView<List<ProfileStepData>> retrieveProfile(@BeanParam @Valid final ProfileRequest profileRequest) {
        List<ProfileStepData> profileStepDataList = profileService.retrieveProfileData(profileRequest);
