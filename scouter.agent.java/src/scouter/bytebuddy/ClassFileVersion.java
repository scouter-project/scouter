...
public class ClassFileVersion implements Comparable<ClassFileVersion> {
    ...
    protected interface VersionLocator {
        ...
        enum CreationAction implements PrivilegedAction<VersionLocator> {
            ...
            public VersionLocator run() {
                try {
                    return new VersionLocator.ForJava9CapableVm(Runtime.class.getMethod("version"), Class.forName("java.lang.Runtime$Version").getMethod("major"));
                } catch (Exception ignored) {
        ...
        class ForJava9CapableVm implements VersionLocator {
            ...
            public boolean equals(final java.lang.Object o) {
                ...
                if (!(o instanceof ClassFileVersion.VersionLocator.ForJava9CapableVm)) return false;
                final ClassFileVersion.VersionLocator.ForJava9CapableVm other = (ClassFileVersion.VersionLocator.ForJava9CapableVm) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$current = this.current;
                final java.lang.Object other$current = other.current;
                if (this$current == null ? other$current != null : !this$current.equals(other$current)) return false;
                final java.lang.Object this$major = this.major;
                final java.lang.Object other$major = other.major;
            ...
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof ClassFileVersion.VersionLocator.ForJava9CapableVm;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $current = this.current;
                result = result * PRIME + ($current == null ? 43 : $current.hashCode());
                final java.lang.Object $major = this.major;
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final ClassFileVersion other = (ClassFileVersion) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
        if (this.versionNumber != other.versionNumber) return false;
        return true;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        result = result * PRIME + this.versionNumber;
        return result;
    }
}
