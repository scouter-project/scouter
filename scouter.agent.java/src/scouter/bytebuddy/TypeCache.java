...
public class TypeCache<T> extends ReferenceQueue<ClassLoader> {
    ...
    public Class<?> insert(ClassLoader classLoader, T key, Class<?> type) {
        ...
        Reference<Class<?>> reference = sort.wrap(type);
        Reference<Class<?>> previous = storage.putIfAbsent(key, reference);
        while (previous != null) {
    ...
    public static class SimpleKey {
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof TypeCache.SimpleKey)) return false;
            final TypeCache.SimpleKey other = (TypeCache.SimpleKey) o;
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof TypeCache.SimpleKey;
        }
