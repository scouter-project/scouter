...
/**
 * A class visitor wrapper is used in order to register an intermediate ASM {@link scouter.bytebuddy.jar.asm.ClassVisitor} which
 * is applied to the main type created by a {@link scouter.bytebuddy.dynamic.DynamicType.Builder} but not
 * to any {@link scouter.bytebuddy.implementation.auxiliary.AuxiliaryType}s, if any.
 */
public interface AsmVisitorWrapper {
    ...
    /**
     * Applies a {@code ClassVisitorWrapper} to the creation of a {@link scouter.bytebuddy.dynamic.DynamicType}.
     *
     * @param instrumentedType      The instrumented type.
     * @param classVisitor          A {@code ClassVisitor} to become the new primary class visitor to which the created
     *                              {@link scouter.bytebuddy.dynamic.DynamicType} is written to.
     ...
     * @param writerFlags           The ASM {@link scouter.bytebuddy.jar.asm.ClassWriter} flags to consider.
     * @param readerFlags           The ASM {@link scouter.bytebuddy.jar.asm.ClassReader} flags to consider.
    ...
    class ForDeclaredMethods implements AsmVisitorWrapper {
        ...
        /**
         * Sets flags for the {@link scouter.bytebuddy.jar.asm.ClassWriter} this wrapper is applied to.
         *
         * @param flags The flags to set for the {@link scouter.bytebuddy.jar.asm.ClassWriter}.
        ...
        /**
         * Sets flags for the {@link scouter.bytebuddy.jar.asm.ClassReader} this wrapper is applied to.
         *
         * @param flags The flags to set for the {@link scouter.bytebuddy.jar.asm.ClassReader}.
        ...
        public interface MethodVisitorWrapper {
             ...
             * @param writerFlags           The ASM {@link scouter.bytebuddy.jar.asm.ClassWriter} reader flags to consider.
             * @param readerFlags           The ASM {@link scouter.bytebuddy.jar.asm.ClassReader} reader flags to consider.
        ...
        protected class DispatchingVisitor extends ClassVisitor {
            ...
            /**
             * The ASM {@link scouter.bytebuddy.jar.asm.ClassWriter} reader flags to consider.
             */
            private final int writerFlags;

            /**
             * The ASM {@link scouter.bytebuddy.jar.asm.ClassReader} reader flags to consider.
             */
            private final int readerFlags;
    ...
    class Compound implements AsmVisitorWrapper {
         ...
         *                          {@link scouter.bytebuddy.jar.asm.ClassVisitor}.
         */
