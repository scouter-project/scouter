 ...
 * {@link scouter.bytebuddy.matcher.ElementMatcher.Junction}.
 *
...
public interface ElementMatcher<T> {
    ...
    /**
     * A junctions allows to chain different {@link scouter.bytebuddy.matcher.ElementMatcher}s in a readable manner.
     *
    ...
    interface Junction<S> extends ElementMatcher<S> {
        ...
        /**
         * A base implementation of {@link scouter.bytebuddy.matcher.ElementMatcher.Junction}.
         *
