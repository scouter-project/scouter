...
public class ModifierMatcher<T extends ModifierReviewable> extends ElementMatcher.Junction.AbstractBase<T> {
    ...
    /**
     * Determines the type of modifier to be matched by a {@link ModifierMatcher}.
     */
    public enum Mode {
        /**
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ModifierMatcher)) return false;
        final ModifierMatcher<?> other = (ModifierMatcher<?>) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
        final java.lang.Object this$mode = this.mode;
        final java.lang.Object other$mode = other.mode;
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final java.lang.Object $mode = this.mode;
