...
public interface TypePool {
     ...
     * {@link scouter.bytebuddy.pool.TypePool.Resolution} represents this type. Otherwise, an illegal resolution is returned.
     */
    ...
    /**
     * A resolution of a {@link scouter.bytebuddy.pool.TypePool} which was queried for a description.
     */
    interface Resolution {
        ...
        /**
         * A canonical representation of a non-successful resolution of a {@link scouter.bytebuddy.pool.TypePool}.
         */
    ...
    /**
     * A cache provider for a {@link scouter.bytebuddy.pool.TypePool}.
     */
    ...
    /**
     * A base implementation of a {@link scouter.bytebuddy.pool.TypePool} that is managing a cache provider and
    ...
    /**
     * <p>
     * A default implementation of a {@link scouter.bytebuddy.pool.TypePool} that models binary data in the Java byte code format
     * into a {@link TypeDescription}. The data lookup is delegated to a {@link scouter.bytebuddy.dynamic.ClassFileLocator}.
     * </p>
     * <p>
    ...
    class Default extends AbstractBase.Hierarchical {
        ...
        /**
         * Creates a default {@link scouter.bytebuddy.pool.TypePool} that looks up data by querying the system class
        ...
        /**
         * Creates a default {@link scouter.bytebuddy.pool.TypePool} that looks up data by querying the supplied class
        ...
        /**
         * Determines the granularity of the class file parsing that is conducted by a {@link scouter.bytebuddy.pool.TypePool.Default}.
         */
        ...
        public static class WithLazyResolution extends Default {
            ...
            /**
             * Creates a default {@link scouter.bytebuddy.pool.TypePool} with lazy resolution that looks up data by querying the system class
             * loader. The returned instance is configured to use a fast reading mode and a simple cache.
             *
             * @return A type pool that reads its data from the system class path.
             */
            ...
            /**
             * Creates a default {@link scouter.bytebuddy.pool.TypePool} with lazy resolution that looks up data by querying the supplied class
             * file locator. The returned instance is configured to use a fast reading mode and a simple cache.
             *
             * @param classFileLocator The class file locator to use.
             * @return A type pool that reads its data from the system class path.
        ...
        protected interface ComponentTypeLocator {
            ...
            class ForAnnotationProperty implements ComponentTypeLocator {
                 ...
                 * {@link scouter.bytebuddy.pool.TypePool.Default.ComponentTypeLocator.ForAnnotationProperty}.
                 */
        ...
        /**
         * A type description that looks up any referenced {@link scouter.bytebuddy.description.ByteCodeElement} or
