...
import scouter.bytebuddy.build.EntryPoint;
import scouter.bytebuddy.build.Plugin;
...
import scouter.bytebuddy.dynamic.NexusAccessor;
 ...
 * </p>
 * <p>
 * When defining several {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s, the agent builder always
...
public interface AgentBuilder {
    ...
    /**
     * Defines the given {@link scouter.bytebuddy.ByteBuddy} instance to be used by the created agent.
     *
    ...
    /**
     * Defines the given {@link scouter.bytebuddy.agent.builder.AgentBuilder.Listener} to be notified by the created agent.
     ...
     * as well as configuring the underlying {@link ByteBuddy} instance to use a {@link scouter.bytebuddy.implementation.Implementation.Context.Disabled}.
     * </p>
     *
    ...
    /**
     * <p>
     * Matches a type being loaded in order to apply the supplied {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s before loading this type.
     ...
     * </p>
     *
     * @param typeMatcher An {@link scouter.bytebuddy.matcher.ElementMatcher} that is applied on the type being loaded that
     *                    decides if the entailed {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s should
     ...
     * {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s to be applied when the given {@code typeMatcher}
     * indicates a match.
     */
     ...
     * </p>
     *
     * @param typeMatcher        An {@link scouter.bytebuddy.matcher.ElementMatcher} that is applied on the type being
     *                           loaded that decides if the entailed
     *                           {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s should be applied for
     *                           that type.
     * @param classLoaderMatcher An {@link scouter.bytebuddy.matcher.ElementMatcher} that is applied to the
     ...
     * @return A definable that represents this agent builder which allows for the definition of one or several
     * {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s to be applied when both the given
     ...
     *                           matcher does not indicate a match.
     * @param moduleMatcher      An {@link scouter.bytebuddy.matcher.ElementMatcher} that is applied to the {@link JavaModule}
     ...
     * </p>
     *
     * @param matcher A matcher that decides if the entailed {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s should be
     *                applied for a type that is being loaded.
     * @return A definable that represents this agent builder which allows for the definition of one or several
     * {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s to be applied when the given {@code matcher}
     * indicates a match.
     */
    ...
    /**
     * Describes an {@link scouter.bytebuddy.agent.builder.AgentBuilder} which was handed a matcher for identifying
     * types to instrumented in order to supply one or several
     * {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s.
     */
    interface Identified {
         ...
         * {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer} to applied when a matcher identifies a type
    ...
    /**
     * A matcher that allows to determine if a {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}
     * should be applied during the execution of a {@link java.lang.instrument.ClassFileTransformer} that was
     * generated by an {@link scouter.bytebuddy.agent.builder.AgentBuilder}.
     */
    interface RawMatcher {
         ...
         * @return {@code true} if the entailed {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s should
        ...
        class ForElementMatchers implements RawMatcher {
            ...
            /**
             * Creates a new {@link scouter.bytebuddy.agent.builder.AgentBuilder.RawMatcher} that only matches the
    ...
    interface Listener {
        ...
        /**
         * A no-op implementation of a {@link scouter.bytebuddy.agent.builder.AgentBuilder.Listener}.
         */
    ...
    /**
     * A transformer allows to apply modifications to a {@link scouter.bytebuddy.dynamic.DynamicType}. Such a modification
     * is then applied to any instrumented type that was matched by the preceding matcher.
     */
    interface Transformer {

        /**
         * Allows for a transformation of a {@link scouter.bytebuddy.dynamic.DynamicType.Builder}.
         *
        ...
        /**
         * A no-op implementation of a {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer} that does
         ...
         * {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s as a single transformer.
         */
    ...
    /**
     * A type locator allows to specify how {@link TypeDescription}s are resolved by an {@link scouter.bytebuddy.agent.builder.AgentBuilder}.
     */
    interface PoolStrategy {
         ...
         * </p>
         * <p>
         * The returned type pool uses a {@link scouter.bytebuddy.pool.TypePool.CacheProvider.Simple} and the
        ...
        enum Default implements PoolStrategy {
             ...
             *
             * @see scouter.bytebuddy.pool.TypePool.Default.ReaderMode#EXTENDED
             */
             ...
             *
             * @see scouter.bytebuddy.pool.TypePool.Default.ReaderMode#FAST
             */
        ...
        abstract class WithTypePoolCache implements PoolStrategy {
            ...
            /**
             * Creates a new type locator that creates {@link TypePool}s but provides a custom {@link scouter.bytebuddy.pool.TypePool.CacheProvider}.
             *
            ...
            public static class Simple extends WithTypePoolCache {
                 ...
                 * locator uses a fast {@link scouter.bytebuddy.pool.TypePool.Default.ReaderMode}.
                 *
    ...
    /**
     * An initialization strategy which determines the handling of {@link scouter.bytebuddy.implementation.LoadedTypeInitializer}s
    ...
    interface InitializationStrategy {
        ...
        abstract class SelfInjection implements InitializationStrategy {
             ...
             * {@link scouter.bytebuddy.implementation.auxiliary.AuxiliaryType.SignatureRelevant} of the instrumented type are loaded lazily and
            ...
            public static class Split extends SelfInjection {
                ...
                /**
                 * A dispatcher for the {@link scouter.bytebuddy.agent.builder.AgentBuilder.InitializationStrategy.SelfInjection.Split} strategy.
                 */
            ...
            public static class Lazy extends SelfInjection {
                ...
                /**
                 * A dispatcher for the {@link scouter.bytebuddy.agent.builder.AgentBuilder.InitializationStrategy.SelfInjection.Lazy} strategy.
                 */
                protected static class Dispatcher extends SelfInjection.Dispatcher {
            ...
            public static class Eager extends SelfInjection {
                ...
                /**
                 * A dispatcher for the {@link scouter.bytebuddy.agent.builder.AgentBuilder.InitializationStrategy.SelfInjection.Eager} strategy.
                 */
                protected static class Dispatcher extends SelfInjection.Dispatcher {
    ...
    interface DescriptionStrategy {
        ...
        enum Default implements DescriptionStrategy {
            ...
            /**
             * A description type strategy represents a type as a {@link scouter.bytebuddy.description.type.TypeDescription.ForLoadedType} if a
    ...
    enum LambdaInstrumentationStrategy {
        ...
        protected enum MetaFactoryRedirection implements AsmVisitorWrapper.ForDeclaredMethods.MethodVisitorWrapper {
            ...
            public MethodVisitor wrap(TypeDescription instrumentedType,
                ...
                methodVisitor.visitLdcInsn("scouter.bytebuddy.agent.builder.LambdaFactory");
    ...
    /**
     * <p>
     * The default implementation of an {@link scouter.bytebuddy.agent.builder.AgentBuilder}.
     * </p>
     * <p>
    ...
    class Default implements AgentBuilder {
        ...
        /**
         * The {@link scouter.bytebuddy.ByteBuddy} instance to be used.
         */
        ...
        /**
         * Creates a new default agent builder that uses a default {@link scouter.bytebuddy.ByteBuddy} instance for creating classes.
         */
        public Default() {
            this(new ByteBuddy());
        }
        ...
        protected abstract class Delegator<T extends Matchable<T>> extends Matchable.AbstractBase<T> implements AgentBuilder {
            ...
            /**
             * Materializes the currently described {@link scouter.bytebuddy.agent.builder.AgentBuilder}.
             *
        ...
        /**
         * A helper class that describes a {@link scouter.bytebuddy.agent.builder.AgentBuilder.Default} after supplying
         * a {@link scouter.bytebuddy.agent.builder.AgentBuilder.RawMatcher} such that one or several
         * {@link scouter.bytebuddy.agent.builder.AgentBuilder.Transformer}s can be supplied.
         */
