 ...
 * </p>
 * <p>
 * When defining several {@link AgentBuilder.Transformer}s, the agent builder always
...
public interface AgentBuilder {
    /**
     * Defines the given {@link ByteBuddy} instance to be used by the created agent.
     *
    ...
    /**
     * Defines the given {@link AgentBuilder.Listener} to be notified by the created agent.
     ...
     * as well as configuring the underlying {@link ByteBuddy} instance to use a {@link Implementation.Context.Disabled}.
    ...
    /**
     * <p>
     * Matches a type being loaded in order to apply the supplied {@link AgentBuilder.Transformer}s before loading this type.
     ...
     * </p>
     *
     * @param typeMatcher An {@link ElementMatcher} that is applied on the type being loaded that
     * decides if the entailed {@link AgentBuilder.Transformer}s should
     ...
     * {@link AgentBuilder.Transformer}s to be applied when the given {@code typeMatcher}
     * indicates a match.
     */
     ...
     * </p>
     *
     * @param typeMatcher        An {@link ElementMatcher} that is applied on the type being
     * loaded that decides if the entailed
     * {@link AgentBuilder.Transformer}s should be applied for
     * that type.
     * @param classLoaderMatcher An {@link ElementMatcher} that is applied to the
     ...
     * @return A definable that represents this agent builder which allows for the definition of one or several
     * {@link AgentBuilder.Transformer}s to be applied when both the given
     ...
     * matcher does not indicate a match.
     * @param moduleMatcher      An {@link ElementMatcher} that is applied to the {@link JavaModule}
     ...
     * </p>
     *
     * @param matcher A matcher that decides if the entailed {@link AgentBuilder.Transformer}s should be
     * applied for a type that is being loaded.
     * @return A definable that represents this agent builder which allows for the definition of one or several
     * {@link AgentBuilder.Transformer}s to be applied when the given {@code matcher}
     * indicates a match.
     */
    ...
    /**
     * Describes an {@link AgentBuilder} which was handed a matcher for identifying
     * types to instrumented in order to supply one or several
     * {@link AgentBuilder.Transformer}s.
     */
    interface Identified {
         ...
         * {@link AgentBuilder.Transformer} to applied when a matcher identifies a type
    ...
    /**
     * A matcher that allows to determine if a {@link AgentBuilder.Transformer}
     * should be applied during the execution of a {@link java.lang.instrument.ClassFileTransformer} that was
     * generated by an {@link AgentBuilder}.
     */
    interface RawMatcher {
         ...
         * @return {@code true} if the entailed {@link AgentBuilder.Transformer}s should
        ...
        class Conjunction implements RawMatcher {
            ...
            @Override
            public boolean matches(TypeDescription typeDescription, ClassLoader classLoader, JavaModule module, Class<?> classBeingRedefined, ProtectionDomain protectionDomain) {
                return left.matches(typeDescription, classLoader, module, classBeingRedefined, protectionDomain) && right.matches(typeDescription, classLoader, module, classBeingRedefined, protectionDomain);
            }
            ...
            public boolean equals(final java.lang.Object o) {
                ...
                if (!(o instanceof AgentBuilder.RawMatcher.Conjunction)) return false;
                final AgentBuilder.RawMatcher.Conjunction other = (AgentBuilder.RawMatcher.Conjunction) o;
            ...
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.RawMatcher.Conjunction;
            }
        ...
        class Disjunction implements RawMatcher {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.RawMatcher.Disjunction)) return false;
                final AgentBuilder.RawMatcher.Disjunction other = (AgentBuilder.RawMatcher.Disjunction) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$left = this.left;
                final java.lang.Object other$left = other.left;
                if (this$left == null ? other$left != null : !this$left.equals(other$left)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.RawMatcher.Disjunction;
            }
        ...
        class Inversion implements RawMatcher {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.RawMatcher.Inversion)) return false;
                final AgentBuilder.RawMatcher.Inversion other = (AgentBuilder.RawMatcher.Inversion) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.RawMatcher.Inversion;
            }
        ...
        class ForElementMatchers implements RawMatcher {
            ...
            /**
             * Creates a new {@link AgentBuilder.RawMatcher} that only matches the
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.RawMatcher.ForElementMatchers)) return false;
                final AgentBuilder.RawMatcher.ForElementMatchers other = (AgentBuilder.RawMatcher.ForElementMatchers) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$typeMatcher = this.typeMatcher;
                final java.lang.Object other$typeMatcher = other.typeMatcher;
                if (this$typeMatcher == null ? other$typeMatcher != null : !this$typeMatcher.equals(other$typeMatcher)) return false;
                final java.lang.Object this$classLoaderMatcher = this.classLoaderMatcher;
                final java.lang.Object other$classLoaderMatcher = other.classLoaderMatcher;
                if (this$classLoaderMatcher == null ? other$classLoaderMatcher != null : !this$classLoaderMatcher.equals(other$classLoaderMatcher)) return false;
                final java.lang.Object this$moduleMatcher = this.moduleMatcher;
                final java.lang.Object other$moduleMatcher = other.moduleMatcher;
                if (this$moduleMatcher == null ? other$moduleMatcher != null : !this$moduleMatcher.equals(other$moduleMatcher)) return false;
                return true;
            }
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.RawMatcher.ForElementMatchers;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $typeMatcher = this.typeMatcher;
                result = result * PRIME + ($typeMatcher == null ? 43 : $typeMatcher.hashCode());
                final java.lang.Object $classLoaderMatcher = this.classLoaderMatcher;
                result = result * PRIME + ($classLoaderMatcher == null ? 43 : $classLoaderMatcher.hashCode());
                final java.lang.Object $moduleMatcher = this.moduleMatcher;
                result = result * PRIME + ($moduleMatcher == null ? 43 : $moduleMatcher.hashCode());
                return result;
            }
        }
    }
    ...
    interface Listener {
        ...
        /**
         * A no-op implementation of a {@link AgentBuilder.Listener}.
         */
        ...
        class StreamWriting implements Listener {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.Listener.StreamWriting)) return false;
                final AgentBuilder.Listener.StreamWriting other = (AgentBuilder.Listener.StreamWriting) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$printStream = this.printStream;
                final java.lang.Object other$printStream = other.printStream;
                if (this$printStream == null ? other$printStream != null : !this$printStream.equals(other$printStream)) return false;
                return true;
            }
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.Listener.StreamWriting;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $printStream = this.printStream;
                result = result * PRIME + ($printStream == null ? 43 : $printStream.hashCode());
                return result;
            }
        }
        ...
        class Filtering implements Listener {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.Listener.Filtering)) return false;
                final AgentBuilder.Listener.Filtering other = (AgentBuilder.Listener.Filtering) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$matcher = this.matcher;
                final java.lang.Object other$matcher = other.matcher;
                if (this$matcher == null ? other$matcher != null : !this$matcher.equals(other$matcher)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.Listener.Filtering;
            }
        ...
        class ModuleReadEdgeCompleting extends Listener.Adapter {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.Listener.ModuleReadEdgeCompleting)) return false;
                final AgentBuilder.Listener.ModuleReadEdgeCompleting other = (AgentBuilder.Listener.ModuleReadEdgeCompleting) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                if (this.addTargetEdge != other.addTargetEdge) return false;
                final java.lang.Object this$modules = this.modules;
                final java.lang.Object other$modules = other.modules;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.Listener.ModuleReadEdgeCompleting;
            }
            ...
            public int hashCode() {
                ...
                result = result * PRIME + (this.addTargetEdge ? 79 : 97);
                final java.lang.Object $modules = this.modules;
        ...
        class Compound implements Listener {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.Listener.Compound)) return false;
                final AgentBuilder.Listener.Compound other = (AgentBuilder.Listener.Compound) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$listeners = this.listeners;
                final java.lang.Object other$listeners = other.listeners;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.Listener.Compound;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $listeners = this.listeners;
    ...
    interface TypeStrategy {
        ...
        class ForBuildEntryPoint implements TypeStrategy {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.TypeStrategy.ForBuildEntryPoint)) return false;
                final AgentBuilder.TypeStrategy.ForBuildEntryPoint other = (AgentBuilder.TypeStrategy.ForBuildEntryPoint) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$entryPoint = this.entryPoint;
                final java.lang.Object other$entryPoint = other.entryPoint;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.TypeStrategy.ForBuildEntryPoint;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $entryPoint = this.entryPoint;
    ...
    /**
     * A transformer allows to apply modifications to a {@link DynamicType}. Such a modification
    ...
    interface Transformer {
        ...
        /**
         * A no-op implementation of a {@link AgentBuilder.Transformer} that does
        ...
        class ForBuildPlugin implements Transformer {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.Transformer.ForBuildPlugin)) return false;
                final AgentBuilder.Transformer.ForBuildPlugin other = (AgentBuilder.Transformer.ForBuildPlugin) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$plugin = this.plugin;
                final java.lang.Object other$plugin = other.plugin;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.Transformer.ForBuildPlugin;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $plugin = this.plugin;
        ...
        class ForAdvice implements Transformer {
            ...
            public ForAdvice(Advice.WithCustomMapping advice) {
                this(advice, Removal.of(TypeDescription.THROWABLE), Assigner.DEFAULT, ClassFileLocator.NoOp.INSTANCE, PoolStrategy.Default.FAST, LocationStrategy.ForClassLoader.STRONG, Collections.<Entry>emptyList());
            }
             ...
             */
            protected ForAdvice(Advice.WithCustomMapping advice, StackManipulation exceptionHandler, Assigner assigner, ClassFileLocator classFileLocator, PoolStrategy poolStrategy, LocationStrategy locationStrategy, List<Entry> entries) {
                this.advice = advice;
            ...
            public DynamicType.Builder<?> transform(DynamicType.Builder<?> builder, TypeDescription typeDescription, ClassLoader classLoader, JavaModule module) {
                ...
                for (Entry entry : entries) {
                    asmVisitorWrapper = asmVisitorWrapper.method(entry.getMatcher().resolve(typeDescription), entry.resolve(advice, typePool, classFileLocator).withAssigner(assigner).withExceptionHandler(exceptionHandler));
                }
            ...
            public ForAdvice include(List<? extends ClassFileLocator> classFileLocators) {
                return new ForAdvice(advice, exceptionHandler, assigner, new ClassFileLocator.Compound(CompoundList.of(classFileLocator, classFileLocators)), poolStrategy, locationStrategy, entries);
            }
            ...
            public ForAdvice advice(LatentMatcher<? super MethodDescription> matcher, String name) {
                return new ForAdvice(advice, exceptionHandler, assigner, classFileLocator, poolStrategy, locationStrategy, CompoundList.of(entries, new Entry.ForUnifiedAdvice(matcher, name)));
            }
            ...
            public ForAdvice advice(LatentMatcher<? super MethodDescription> matcher, String enter, String exit) {
                return new ForAdvice(advice, exceptionHandler, assigner, classFileLocator, poolStrategy, locationStrategy, CompoundList.of(entries, new Entry.ForSplitAdvice(matcher, enter, exit)));
            }
            ...
            protected static abstract class Entry {
                ...
                protected static class ForUnifiedAdvice extends Entry {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.Transformer.ForAdvice.Entry.ForUnifiedAdvice)) return false;
                        final AgentBuilder.Transformer.ForAdvice.Entry.ForUnifiedAdvice other = (AgentBuilder.Transformer.ForAdvice.Entry.ForUnifiedAdvice) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.Transformer.ForAdvice.Entry.ForUnifiedAdvice;
                    }
                ...
                protected static class ForSplitAdvice extends Entry {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.Transformer.ForAdvice.Entry.ForSplitAdvice)) return false;
                        final AgentBuilder.Transformer.ForAdvice.Entry.ForSplitAdvice other = (AgentBuilder.Transformer.ForAdvice.Entry.ForSplitAdvice) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        if (!super.equals(o)) return false;
                        final java.lang.Object this$enter = this.enter;
                        final java.lang.Object other$enter = other.enter;
                        if (this$enter == null ? other$enter != null : !this$enter.equals(other$enter)) return false;
                        final java.lang.Object this$exit = this.exit;
                        final java.lang.Object other$exit = other.exit;
                        if (this$exit == null ? other$exit != null : !this$exit.equals(other$exit)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.Transformer.ForAdvice.Entry.ForSplitAdvice;
                    }
                    ...
                    public int hashCode() {
                        ...
                        int result = 1;
                        result = result * PRIME + super.hashCode();
                        final java.lang.Object $enter = this.enter;
                        result = result * PRIME + ($enter == null ? 43 : $enter.hashCode());
                        final java.lang.Object $exit = this.exit;
                        result = result * PRIME + ($exit == null ? 43 : $exit.hashCode());
                        return result;
                    }
                }
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.Transformer.ForAdvice.Entry)) return false;
                    final AgentBuilder.Transformer.ForAdvice.Entry other = (AgentBuilder.Transformer.ForAdvice.Entry) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$matcher = this.getMatcher();
                    final java.lang.Object other$matcher = other.getMatcher();
                    if (this$matcher == null ? other$matcher != null : !this$matcher.equals(other$matcher)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.Transformer.ForAdvice.Entry;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    final java.lang.Object $matcher = this.getMatcher();
                    result = result * PRIME + ($matcher == null ? 43 : $matcher.hashCode());
                    return result;
                }
            }
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.Transformer.ForAdvice)) return false;
                final AgentBuilder.Transformer.ForAdvice other = (AgentBuilder.Transformer.ForAdvice) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                final java.lang.Object this$poolStrategy = this.poolStrategy;
                final java.lang.Object other$poolStrategy = other.poolStrategy;
                if (this$poolStrategy == null ? other$poolStrategy != null : !this$poolStrategy.equals(other$poolStrategy)) return false;
                final java.lang.Object this$locationStrategy = this.locationStrategy;
                final java.lang.Object other$locationStrategy = other.locationStrategy;
                if (this$locationStrategy == null ? other$locationStrategy != null : !this$locationStrategy.equals(other$locationStrategy)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.Transformer.ForAdvice;
            }
            ...
            public int hashCode() {
                ...
                final java.lang.Object $poolStrategy = this.poolStrategy;
                result = result * PRIME + ($poolStrategy == null ? 43 : $poolStrategy.hashCode());
                final java.lang.Object $locationStrategy = this.locationStrategy;
                result = result * PRIME + ($locationStrategy == null ? 43 : $locationStrategy.hashCode());
         ...
         * {@link AgentBuilder.Transformer}s as a single transformer.
         */
        class Compound implements Transformer {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.Transformer.Compound)) return false;
                final AgentBuilder.Transformer.Compound other = (AgentBuilder.Transformer.Compound) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.Transformer.Compound;
            }
    ...
    /**
     * A type locator allows to specify how {@link TypeDescription}s are resolved by an {@link AgentBuilder}.
     */
    interface PoolStrategy {
         ...
         * </p>
         * <p>
         * The returned type pool uses a {@link TypePool.CacheProvider.Simple} and the
        ...
        enum Default implements PoolStrategy {
             ...
             *
             * @see TypePool.Default.ReaderMode#EXTENDED
             */
             ...
             *
             * @see TypePool.Default.ReaderMode#FAST
             */
        ...
        abstract class WithTypePoolCache implements PoolStrategy {
            ...
            public static class Simple extends WithTypePoolCache {
                 ...
                 * locator uses a fast {@link TypePool.Default.ReaderMode}.
                 *
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.PoolStrategy.WithTypePoolCache.Simple)) return false;
                    final AgentBuilder.PoolStrategy.WithTypePoolCache.Simple other = (AgentBuilder.PoolStrategy.WithTypePoolCache.Simple) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                    final java.lang.Object this$cacheProviders = this.cacheProviders;
                    final java.lang.Object other$cacheProviders = other.cacheProviders;
                    if (this$cacheProviders == null ? other$cacheProviders != null : !this$cacheProviders.equals(other$cacheProviders)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.PoolStrategy.WithTypePoolCache.Simple;
                }
                ...
                public int hashCode() {
                    ...
                    int result = 1;
                    result = result * PRIME + super.hashCode();
                    final java.lang.Object $cacheProviders = this.cacheProviders;
                    result = result * PRIME + ($cacheProviders == null ? 43 : $cacheProviders.hashCode());
                    return result;
                }
            }
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.PoolStrategy.WithTypePoolCache)) return false;
                final AgentBuilder.PoolStrategy.WithTypePoolCache other = (AgentBuilder.PoolStrategy.WithTypePoolCache) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.PoolStrategy.WithTypePoolCache;
            }
    ...
    /**
     * An initialization strategy which determines the handling of {@link LoadedTypeInitializer}s
    ...
    interface InitializationStrategy {
        ...
        abstract class SelfInjection implements InitializationStrategy {
             ...
             */
            protected static abstract class Dispatcher implements InitializationStrategy.Dispatcher {
                /**
                 * The nexus accessor to use.
                 */
                protected final NexusAccessor nexusAccessor;
                ...
                protected static class InjectingInitializer implements LoadedTypeInitializer {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.InitializationStrategy.SelfInjection.Dispatcher.InjectingInitializer)) return false;
                        final AgentBuilder.InitializationStrategy.SelfInjection.Dispatcher.InjectingInitializer other = (AgentBuilder.InitializationStrategy.SelfInjection.Dispatcher.InjectingInitializer) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        ...
                        final java.lang.Object this$rawAuxiliaryTypes = this.rawAuxiliaryTypes;
                        final java.lang.Object other$rawAuxiliaryTypes = other.rawAuxiliaryTypes;
                        if (this$rawAuxiliaryTypes == null ? other$rawAuxiliaryTypes != null : !this$rawAuxiliaryTypes.equals(other$rawAuxiliaryTypes)) return false;
                        ...
                        final java.lang.Object this$classInjector = this.classInjector;
                        final java.lang.Object other$classInjector = other.classInjector;
                        if (this$classInjector == null ? other$classInjector != null : !this$classInjector.equals(other$classInjector)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.InitializationStrategy.SelfInjection.Dispatcher.InjectingInitializer;
                    }
                    ...
                    public int hashCode() {
                        ...
                        final java.lang.Object $rawAuxiliaryTypes = this.rawAuxiliaryTypes;
                        result = result * PRIME + ($rawAuxiliaryTypes == null ? 43 : $rawAuxiliaryTypes.hashCode());
                        ...
                        final java.lang.Object $classInjector = this.classInjector;
                        result = result * PRIME + ($classInjector == null ? 43 : $classInjector.hashCode());
                        return result;
                    }
                }
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.InitializationStrategy.SelfInjection.Dispatcher)) return false;
                    final AgentBuilder.InitializationStrategy.SelfInjection.Dispatcher other = (AgentBuilder.InitializationStrategy.SelfInjection.Dispatcher) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.InitializationStrategy.SelfInjection.Dispatcher;
                }
             ...
             * {@link AuxiliaryType.SignatureRelevant} of the instrumented type are loaded lazily and
            ...
            public static class Split extends SelfInjection {
                ...
                /**
                 * A dispatcher for the {@link AgentBuilder.InitializationStrategy.SelfInjection.Split} strategy.
                 */
                protected static class Dispatcher extends SelfInjection.Dispatcher {
                    ...
                    public void register(DynamicType dynamicType, ClassLoader classLoader, InitializationStrategy.Dispatcher.InjectorFactory injectorFactory) {
                        ...
                        if (!auxiliaryTypes.isEmpty()) {
                            ...
                            loadedTypeInitializer =  // there exist auxiliary types that need lazy loading
                            /**
                     ...
                     * @param identification A random identification for the applied self-initialization.
                     */
                            lazyInitializers.size() > 1 ? new Dispatcher.InjectingInitializer(instrumentedType, dependentTypes, lazyInitializers, classInjector) : lazyInitializers.get(instrumentedType);
                        } else {
            ...
            public static class Lazy extends SelfInjection {
                ...
                /**
                 * A dispatcher for the {@link AgentBuilder.InitializationStrategy.SelfInjection.Lazy} strategy.
                 */
                protected static class Dispatcher extends SelfInjection.Dispatcher {
                    /**
            ...
            public static class Eager extends SelfInjection {
                ...
                /**
                 * A dispatcher for the {@link AgentBuilder.InitializationStrategy.SelfInjection.Eager} strategy.
                 */
                protected static class Dispatcher extends SelfInjection.Dispatcher {
                    /**
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.InitializationStrategy.SelfInjection)) return false;
                final AgentBuilder.InitializationStrategy.SelfInjection other = (AgentBuilder.InitializationStrategy.SelfInjection) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$nexusAccessor = this.nexusAccessor;
                final java.lang.Object other$nexusAccessor = other.nexusAccessor;
                if (this$nexusAccessor == null ? other$nexusAccessor != null : !this$nexusAccessor.equals(other$nexusAccessor)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.InitializationStrategy.SelfInjection;
            }
    ...
    interface DescriptionStrategy {
        ...
        enum Default implements DescriptionStrategy {
            /**
             * A description type strategy represents a type as a {@link TypeDescription.ForLoadedType} if a
        ...
        class SuperTypeLoading implements DescriptionStrategy {
            ...
            protected static class UnlockingClassLoadingDelegate implements TypeDescription.SuperTypeLoading.ClassLoadingDelegate {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading.UnlockingClassLoadingDelegate)) return false;
                    final AgentBuilder.DescriptionStrategy.SuperTypeLoading.UnlockingClassLoadingDelegate other = (AgentBuilder.DescriptionStrategy.SuperTypeLoading.UnlockingClassLoadingDelegate) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$circularityLock = this.circularityLock;
                    final java.lang.Object other$circularityLock = other.circularityLock;
                    if (this$circularityLock == null ? other$circularityLock != null : !this$circularityLock.equals(other$circularityLock)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading.UnlockingClassLoadingDelegate;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    final java.lang.Object $circularityLock = this.circularityLock;
                    result = result * PRIME + ($circularityLock == null ? 43 : $circularityLock.hashCode());
                    return result;
                }
            }
            ...
            public static class Asynchronous implements DescriptionStrategy {
                ...
                protected static class ThreadSwitchingClassLoadingDelegate implements TypeDescription.SuperTypeLoading.ClassLoadingDelegate {
                    ...
                    protected static class SimpleClassLoadingAction implements Callable<Class<?>> {
                        ...
                        public boolean equals(final java.lang.Object o) {
                            if (o == this) return true;
                            if (!(o instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous.ThreadSwitchingClassLoadingDelegate.SimpleClassLoadingAction)) return false;
                            final AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous.ThreadSwitchingClassLoadingDelegate.SimpleClassLoadingAction other = (AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous.ThreadSwitchingClassLoadingDelegate.SimpleClassLoadingAction) o;
                            if (!other.canEqual((java.lang.Object) this)) return false;
                            final java.lang.Object this$name = this.name;
                            final java.lang.Object other$name = other.name;
                            if (this$name == null ? other$name != null : !this$name.equals(other$name)) return false;
                        ...
                        @javax.annotation.Generated("lombok")
                        protected boolean canEqual(final java.lang.Object other) {
                            return other instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous.ThreadSwitchingClassLoadingDelegate.SimpleClassLoadingAction;
                        }
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous.ThreadSwitchingClassLoadingDelegate)) return false;
                        final AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous.ThreadSwitchingClassLoadingDelegate other = (AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous.ThreadSwitchingClassLoadingDelegate) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$executorService = this.executorService;
                        final java.lang.Object other$executorService = other.executorService;
                        if (this$executorService == null ? other$executorService != null : !this$executorService.equals(other$executorService)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous.ThreadSwitchingClassLoadingDelegate;
                    }
                    ...
                    public int hashCode() {
                        final int PRIME = 59;
                        int result = 1;
                        final java.lang.Object $executorService = this.executorService;
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous)) return false;
                    final AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous other = (AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$delegate = this.delegate;
                    final java.lang.Object other$delegate = other.delegate;
                    if (this$delegate == null ? other$delegate != null : !this$delegate.equals(other$delegate)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading.Asynchronous;
                }
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading)) return false;
                final AgentBuilder.DescriptionStrategy.SuperTypeLoading other = (AgentBuilder.DescriptionStrategy.SuperTypeLoading) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$delegate = this.delegate;
                final java.lang.Object other$delegate = other.delegate;
                if (this$delegate == null ? other$delegate != null : !this$delegate.equals(other$delegate)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.DescriptionStrategy.SuperTypeLoading;
            }
    ...
    interface LocationStrategy {
        ...
        class Simple implements LocationStrategy {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.LocationStrategy.Simple)) return false;
                final AgentBuilder.LocationStrategy.Simple other = (AgentBuilder.LocationStrategy.Simple) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$classFileLocator = this.classFileLocator;
                final java.lang.Object other$classFileLocator = other.classFileLocator;
                if (this$classFileLocator == null ? other$classFileLocator != null : !this$classFileLocator.equals(other$classFileLocator)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.LocationStrategy.Simple;
            }
        ...
        class Compound implements LocationStrategy {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.LocationStrategy.Compound)) return false;
                final AgentBuilder.LocationStrategy.Compound other = (AgentBuilder.LocationStrategy.Compound) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$locationStrategies = this.locationStrategies;
                final java.lang.Object other$locationStrategies = other.locationStrategies;
                if (this$locationStrategies == null ? other$locationStrategies != null : !this$locationStrategies.equals(other$locationStrategies)) return false;
                return true;
            }
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.LocationStrategy.Compound;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $locationStrategies = this.locationStrategies;
                result = result * PRIME + ($locationStrategies == null ? 43 : $locationStrategies.hashCode());
                return result;
            }
        }
    }
    ...
    interface FallbackStrategy {
        ...
        class ByThrowableType implements FallbackStrategy {
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.FallbackStrategy.ByThrowableType)) return false;
                final AgentBuilder.FallbackStrategy.ByThrowableType other = (AgentBuilder.FallbackStrategy.ByThrowableType) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.FallbackStrategy.ByThrowableType;
            }
    ...
    enum RedefinitionStrategy {
         ...
         */
        public void apply(Instrumentation instrumentation, AgentBuilder.Listener listener, CircularityLock circularityLock, PoolStrategy poolStrategy, LocationStrategy locationStrategy, BatchAllocator redefinitionBatchAllocator, Listener redefinitionListener, LambdaInstrumentationStrategy lambdaInstrumentationStrategy, DescriptionStrategy descriptionStrategy, FallbackStrategy fallbackStrategy, RawMatcher typeMatcher, RawMatcher ignoredTypeMatcher) {
            ...
            for (Class<?> type : instrumentation.getAllLoadedClasses()) {
                ...
                try {
                    ...
                    try {
                        collector.consider(typeMatcher, ignoredTypeMatcher, listener, descriptionStrategy.apply(TypeDescription.ForLoadedType.getName(type), type, typePool, circularityLock, type.getClassLoader(), module), type, type, module, !instrumentation.isModifiableClass(type));
                    } catch (Throwable throwable) {
                        if (descriptionStrategy.isLoadedFirst() && fallbackStrategy.isFallback(type, throwable)) {
                            collector.consider(typeMatcher, ignoredTypeMatcher, listener, typePool.describe(TypeDescription.ForLoadedType.getName(type)).resolve(), type, module);
                        } else {
                            throw throwable;
                        }
                    }
        ...
        public interface BatchAllocator {
            ...
            class ForFixedSize implements BatchAllocator {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.BatchAllocator.ForFixedSize)) return false;
                    final AgentBuilder.RedefinitionStrategy.BatchAllocator.ForFixedSize other = (AgentBuilder.RedefinitionStrategy.BatchAllocator.ForFixedSize) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.BatchAllocator.ForFixedSize;
                }
            ...
            class ForMatchedGrouping implements BatchAllocator {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.BatchAllocator.ForMatchedGrouping)) return false;
                    final AgentBuilder.RedefinitionStrategy.BatchAllocator.ForMatchedGrouping other = (AgentBuilder.RedefinitionStrategy.BatchAllocator.ForMatchedGrouping) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.BatchAllocator.ForMatchedGrouping;
                }
            ...
            class Slicing implements BatchAllocator {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.BatchAllocator.Slicing)) return false;
                    final AgentBuilder.RedefinitionStrategy.BatchAllocator.Slicing other = (AgentBuilder.RedefinitionStrategy.BatchAllocator.Slicing) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (this.minimum != other.minimum) return false;
                    if (this.maximum != other.maximum) return false;
                    final java.lang.Object this$batchAllocator = this.batchAllocator;
                    final java.lang.Object other$batchAllocator = other.batchAllocator;
                    if (this$batchAllocator == null ? other$batchAllocator != null : !this$batchAllocator.equals(other$batchAllocator)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.BatchAllocator.Slicing;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    result = result * PRIME + this.minimum;
                    result = result * PRIME + this.maximum;
                    final java.lang.Object $batchAllocator = this.batchAllocator;
                    result = result * PRIME + ($batchAllocator == null ? 43 : $batchAllocator.hashCode());
                    return result;
                }
            }
            ...
            class Partitioning implements BatchAllocator {
                ...
                public Iterable<? extends List<Class<?>>> batch(List<Class<?>> types) {
                    if (types.isEmpty()) {
                        ...
                        List<List<Class<?>>> batches = new ArrayList<List<Class<?>>>();
                        int size = types.size() / parts;
                        int reminder = types.size() % parts;
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.BatchAllocator.Partitioning)) return false;
                    final AgentBuilder.RedefinitionStrategy.BatchAllocator.Partitioning other = (AgentBuilder.RedefinitionStrategy.BatchAllocator.Partitioning) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (this.parts != other.parts) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.BatchAllocator.Partitioning;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    result = result * PRIME + this.parts;
                    return result;
                }
            }
        }
        ...
        public interface Listener {
            ...
            abstract class Adapter implements Listener {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.Listener.Adapter)) return false;
                    final AgentBuilder.RedefinitionStrategy.Listener.Adapter other = (AgentBuilder.RedefinitionStrategy.Listener.Adapter) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.Listener.Adapter;
                }
            ...
            class BatchReallocator extends Adapter {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.Listener.BatchReallocator)) return false;
                    final AgentBuilder.RedefinitionStrategy.Listener.BatchReallocator other = (AgentBuilder.RedefinitionStrategy.Listener.BatchReallocator) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$batchAllocator = this.batchAllocator;
                    final java.lang.Object other$batchAllocator = other.batchAllocator;
                    if (this$batchAllocator == null ? other$batchAllocator != null : !this$batchAllocator.equals(other$batchAllocator)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.Listener.BatchReallocator;
                }
            ...
            class Pausing extends Adapter {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.Listener.Pausing)) return false;
                    final AgentBuilder.RedefinitionStrategy.Listener.Pausing other = (AgentBuilder.RedefinitionStrategy.Listener.Pausing) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.Listener.Pausing;
                }
            ...
            class StreamWriting implements Listener {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.Listener.StreamWriting)) return false;
                    final AgentBuilder.RedefinitionStrategy.Listener.StreamWriting other = (AgentBuilder.RedefinitionStrategy.Listener.StreamWriting) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$printStream = this.printStream;
                    final java.lang.Object other$printStream = other.printStream;
                    if (this$printStream == null ? other$printStream != null : !this$printStream.equals(other$printStream)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.Listener.StreamWriting;
                }
            ...
            class Compound implements Listener {
                ...
                protected static class CompoundIterable implements Iterable<List<Class<?>>> {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.RedefinitionStrategy.Listener.Compound.CompoundIterable)) return false;
                        final AgentBuilder.RedefinitionStrategy.Listener.Compound.CompoundIterable other = (AgentBuilder.RedefinitionStrategy.Listener.Compound.CompoundIterable) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$iterables = this.iterables;
                        final java.lang.Object other$iterables = other.iterables;
                        if (this$iterables == null ? other$iterables != null : !this$iterables.equals(other$iterables)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.RedefinitionStrategy.Listener.Compound.CompoundIterable;
                    }
                    ...
                    public int hashCode() {
                        final int PRIME = 59;
                        int result = 1;
                        final java.lang.Object $iterables = this.iterables;
                        result = result * PRIME + ($iterables == null ? 43 : $iterables.hashCode());
                        return result;
                    }
                }
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.Listener.Compound)) return false;
                    final AgentBuilder.RedefinitionStrategy.Listener.Compound other = (AgentBuilder.RedefinitionStrategy.Listener.Compound) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$listeners = this.listeners;
                    final java.lang.Object other$listeners = other.listeners;
                    if (this$listeners == null ? other$listeners != null : !this$listeners.equals(other$listeners)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.Listener.Compound;
                }
        ...
        public interface ResubmissionScheduler {
            ...
            class AtFixedRate implements ResubmissionScheduler {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.ResubmissionScheduler.AtFixedRate)) return false;
                    final AgentBuilder.RedefinitionStrategy.ResubmissionScheduler.AtFixedRate other = (AgentBuilder.RedefinitionStrategy.ResubmissionScheduler.AtFixedRate) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$scheduledExecutorService = this.scheduledExecutorService;
                    final java.lang.Object other$scheduledExecutorService = other.scheduledExecutorService;
                    if (this$scheduledExecutorService == null ? other$scheduledExecutorService != null : !this$scheduledExecutorService.equals(other$scheduledExecutorService)) return false;
                    if (this.time != other.time) return false;
                    final java.lang.Object this$timeUnit = this.timeUnit;
                    final java.lang.Object other$timeUnit = other.timeUnit;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.ResubmissionScheduler.AtFixedRate;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    final java.lang.Object $scheduledExecutorService = this.scheduledExecutorService;
                    result = result * PRIME + ($scheduledExecutorService == null ? 43 : $scheduledExecutorService.hashCode());
                    final long $time = this.time;
                    result = result * PRIME + (int) ($time >>> 32 ^ $time);
                    final java.lang.Object $timeUnit = this.timeUnit;
            ...
            class WithFixedDelay implements ResubmissionScheduler {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.ResubmissionScheduler.WithFixedDelay)) return false;
                    final AgentBuilder.RedefinitionStrategy.ResubmissionScheduler.WithFixedDelay other = (AgentBuilder.RedefinitionStrategy.ResubmissionScheduler.WithFixedDelay) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$scheduledExecutorService = this.scheduledExecutorService;
                    final java.lang.Object other$scheduledExecutorService = other.scheduledExecutorService;
                    if (this$scheduledExecutorService == null ? other$scheduledExecutorService != null : !this$scheduledExecutorService.equals(other$scheduledExecutorService)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.ResubmissionScheduler.WithFixedDelay;
                }
        ...
        protected interface ResubmissionStrategy {
            ...
            enum Disabled implements ResubmissionStrategy {
                ...
                @Override
                public AgentBuilder.Listener onInstall(Instrumentation instrumentation, LocationStrategy locationStrategy, AgentBuilder.Listener listener, CircularityLock circularityLock, RawMatcher matcher, RedefinitionStrategy redefinitionStrategy, BatchAllocator redefinitionBatchAllocator, Listener redefinitionBatchListener) {
                    return listener;
                }
            }
            ...
            class Enabled implements ResubmissionStrategy {
                ...
                public AgentBuilder.Listener onInstall(Instrumentation instrumentation, LocationStrategy locationStrategy, AgentBuilder.Listener listener, CircularityLock circularityLock, RawMatcher matcher, RedefinitionStrategy redefinitionStrategy, RedefinitionStrategy.BatchAllocator redefinitionBatchAllocator, RedefinitionStrategy.Listener redefinitionBatchListener) {
                    if (redefinitionStrategy.isEnabled() && resubmissionScheduler.isAlive()) {
                        ...
                        resubmissionScheduler.schedule(new ResubmissionJob(instrumentation, locationStrategy, listener, circularityLock, matcher, redefinitionStrategy, redefinitionBatchAllocator, redefinitionBatchListener, types));
                ...
                protected static class ResubmissionJob implements Runnable {
                    ...
                    protected ResubmissionJob(Instrumentation instrumentation, LocationStrategy locationStrategy, AgentBuilder.Listener listener, CircularityLock circularityLock, RawMatcher matcher, RedefinitionStrategy redefinitionStrategy, BatchAllocator redefinitionBatchAllocator, Listener redefinitionBatchListener, ConcurrentMap<StorageKey, Set<String>> types) {
                        this.instrumentation = instrumentation;
                        this.locationStrategy = locationStrategy;
                                ...
                                if (classLoader != null || entry.getKey().isBootstrapLoader()) {
                                    ...
                                    while (iterator.hasNext()) {
                                        try {
                                            ...
                                            try {
                                                if (instrumentation.isModifiableClass(type) && matcher.matches(new TypeDescription.ForLoadedType(type), type.getClassLoader(), JavaModule.ofType(type), type, type.getProtectionDomain())) {
                                                    types.add(type);
                                                }
                                            } catch (Throwable throwable) {
                                                try {
                                                    listener.onError(TypeDescription.ForLoadedType.getName(type), type.getClassLoader(), JavaModule.ofType(type), AgentBuilder.Listener.LOADED, throwable);
                                                } finally {
                                                    listener.onComplete(TypeDescription.ForLoadedType.getName(type), type.getClassLoader(), JavaModule.ofType(type), AgentBuilder.Listener.LOADED);
                                                }
                                            }
                                        } catch (Throwable ignored) {
                                        } finally {
                     ...
                     */
                            ...
                            if (!types.isEmpty()) {
                                ...
                                collector.apply(instrumentation, circularityLock, locationStrategy, listener, redefinitionBatchAllocator, redefinitionBatchListener);
                            }
                        } finally {
                            if (release) {
                                circularityLock.release();
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.RedefinitionStrategy.ResubmissionStrategy.Enabled)) return false;
                    final AgentBuilder.RedefinitionStrategy.ResubmissionStrategy.Enabled other = (AgentBuilder.RedefinitionStrategy.ResubmissionStrategy.Enabled) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$resubmissionScheduler = this.resubmissionScheduler;
                    final java.lang.Object other$resubmissionScheduler = other.resubmissionScheduler;
                    if (this$resubmissionScheduler == null ? other$resubmissionScheduler != null : !this$resubmissionScheduler.equals(other$resubmissionScheduler)) return false;
                    final java.lang.Object this$matcher = this.matcher;
                    final java.lang.Object other$matcher = other.matcher;
                    if (this$matcher == null ? other$matcher != null : !this$matcher.equals(other$matcher)) return false;
                    return true;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.RedefinitionStrategy.ResubmissionStrategy.Enabled;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    final java.lang.Object $resubmissionScheduler = this.resubmissionScheduler;
                    result = result * PRIME + ($resubmissionScheduler == null ? 43 : $resubmissionScheduler.hashCode());
                    final java.lang.Object $matcher = this.matcher;
                    result = result * PRIME + ($matcher == null ? 43 : $matcher.hashCode());
                    return result;
                }
        ...
        protected static abstract class Collector {
             ...
             */
            protected void consider(RawMatcher typeMatcher, RawMatcher ignoredTypeMatcher, AgentBuilder.Listener listener, TypeDescription typeDescription, Class<?> type, JavaModule module) {
                consider(typeMatcher, ignoredTypeMatcher, listener, typeDescription, type, NO_LOADED_TYPE, module, false);
            }

            protected void consider(RawMatcher typeMatcher, RawMatcher ignoredTypeMatcher, AgentBuilder.Listener listener, TypeDescription typeDescription, Class<?> type, Class<?> classBeingRedefined, JavaModule module, boolean unmodifiable) {
                if (unmodifiable || ignoredTypeMatcher.matches(typeDescription, type.getClassLoader(), module, classBeingRedefined, type.getProtectionDomain()) || !typeMatcher.matches(typeDescription, type.getClassLoader(), module, classBeingRedefined, type.getProtectionDomain()) || !types.add(type)) {
                    try {
                        try {
             ...
             */
            protected void apply(Instrumentation instrumentation, CircularityLock circularityLock, LocationStrategy locationStrategy, AgentBuilder.Listener listener, BatchAllocator redefinitionBatchAllocator, Listener redefinitionListener) {
                int index = 0;
             ...
             */
            protected abstract void doApply(Instrumentation instrumentation, CircularityLock circularityLock, List<Class<?>> types, LocationStrategy locationStrategy, AgentBuilder.Listener listener) throws UnmodifiableClassException, ClassNotFoundException;
            ...
            protected static class ForRedefinition extends Collector {
                @Override
                protected void doApply(Instrumentation instrumentation, CircularityLock circularityLock, List<Class<?>> types, LocationStrategy locationStrategy, AgentBuilder.Listener listener) throws UnmodifiableClassException, ClassNotFoundException {
            ...
            protected static class ForRetransformation extends Collector {
                @Override
                protected void doApply(Instrumentation instrumentation, CircularityLock circularityLock, List<Class<?>> types, LocationStrategy locationStrategy, AgentBuilder.Listener listener) throws UnmodifiableClassException {
                    if (!types.isEmpty()) {
                        circularityLock.release();
                        try {
    ...
    enum LambdaInstrumentationStrategy {
         ...
         */
        private static final String UNSAFE_CLASS = ClassFileVersion.ofThisVm(ClassFileVersion.JAVA_V6).isAtLeast(ClassFileVersion.JAVA_V9) ? "jdk/internal/misc/Unsafe" : "sun/misc/Unsafe";
        /**
        ...
        protected static class LambdaInstanceFactory {
            ...
            protected enum ConstructorImplementation implements Implementation {
                ...
                ConstructorImplementation() {
                    objectConstructor = TypeDescription.OBJECT.getDeclaredMethods().filter(ElementMatchers.isConstructor()).getOnly();
                }
                ...
                protected static class Appender implements ByteCodeAppender {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.ConstructorImplementation.Appender)) return false;
                        final AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.ConstructorImplementation.Appender other = (AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.ConstructorImplementation.Appender) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$declaredFields = this.declaredFields;
                        final java.lang.Object other$declaredFields = other.declaredFields;
                        if (this$declaredFields == null ? other$declaredFields != null : !this$declaredFields.equals(other$declaredFields)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.ConstructorImplementation.Appender;
                    }
                    ...
                    public int hashCode() {
                        final int PRIME = 59;
                        int result = 1;
                        final java.lang.Object $declaredFields = this.declaredFields;
                        result = result * PRIME + ($declaredFields == null ? 43 : $declaredFields.hashCode());
                        return result;
                    }
                }
            }
            ...
            protected enum FactoryImplementation implements Implementation {
                ...
                protected static class Appender implements ByteCodeAppender {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.FactoryImplementation.Appender)) return false;
                        final AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.FactoryImplementation.Appender other = (AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.FactoryImplementation.Appender) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$instrumentedType = this.instrumentedType;
                        final java.lang.Object other$instrumentedType = other.instrumentedType;
                        if (this$instrumentedType == null ? other$instrumentedType != null : !this$instrumentedType.equals(other$instrumentedType)) return false;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.FactoryImplementation.Appender;
                    }
            ...
            protected static class LambdaMethodImplementation implements Implementation {
                ...
                @Override
                public ByteCodeAppender appender(Target implementationTarget) {
                    return new Appender(targetMethod.getOwnerType().getDeclaredMethods().filter(ElementMatchers.named(targetMethod.getName()).and(returns(targetMethod.getReturnType())).and(takesArguments(targetMethod.getParameterTypes()))).getOnly(), specializedLambdaMethod, implementationTarget.getInstrumentedType().getDeclaredFields());
                }
                ...
                protected static class Appender implements ByteCodeAppender {
                    ...
                    public Size apply(MethodVisitor methodVisitor, Context implementationContext, MethodDescription instrumentedMethod) {
                        ...
                        return new Size(new StackManipulation.Compound(new StackManipulation.Compound(fieldAccess), new StackManipulation.Compound(parameterAccess), MethodInvocation.invoke(targetMethod), MethodReturn.of(targetMethod.getReturnType())).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
                    }
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.LambdaMethodImplementation.Appender)) return false;
                        final AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.LambdaMethodImplementation.Appender other = (AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.LambdaMethodImplementation.Appender) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$targetMethod = this.targetMethod;
                        final java.lang.Object other$targetMethod = other.targetMethod;
                        if (this$targetMethod == null ? other$targetMethod != null : !this$targetMethod.equals(other$targetMethod)) return false;
                        final java.lang.Object this$specializedLambdaMethod = this.specializedLambdaMethod;
                        final java.lang.Object other$specializedLambdaMethod = other.specializedLambdaMethod;
                        if (this$specializedLambdaMethod == null ? other$specializedLambdaMethod != null : !this$specializedLambdaMethod.equals(other$specializedLambdaMethod)) return false;
                        final java.lang.Object this$declaredFields = this.declaredFields;
                        final java.lang.Object other$declaredFields = other.declaredFields;
                        if (this$declaredFields == null ? other$declaredFields != null : !this$declaredFields.equals(other$declaredFields)) return false;
                        return true;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.LambdaMethodImplementation.Appender;
                    }
                    ...
                    public int hashCode() {
                        final int PRIME = 59;
                        int result = 1;
                        final java.lang.Object $targetMethod = this.targetMethod;
                        result = result * PRIME + ($targetMethod == null ? 43 : $targetMethod.hashCode());
                        final java.lang.Object $specializedLambdaMethod = this.specializedLambdaMethod;
                        result = result * PRIME + ($specializedLambdaMethod == null ? 43 : $specializedLambdaMethod.hashCode());
                        final java.lang.Object $declaredFields = this.declaredFields;
                        result = result * PRIME + ($declaredFields == null ? 43 : $declaredFields.hashCode());
                        return result;
                    }
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.LambdaMethodImplementation)) return false;
                    final AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.LambdaMethodImplementation other = (AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.LambdaMethodImplementation) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$targetMethod = this.targetMethod;
                    final java.lang.Object other$targetMethod = other.targetMethod;
                    if (this$targetMethod == null ? other$targetMethod != null : !this$targetMethod.equals(other$targetMethod)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.LambdaMethodImplementation;
                }
            ...
            protected static class SerializationImplementation implements Implementation {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.SerializationImplementation)) return false;
                    final AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.SerializationImplementation other = (AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.SerializationImplementation) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    ...
                    final java.lang.Object this$lambdaType = this.lambdaType;
                    final java.lang.Object other$lambdaType = other.lambdaType;
                    if (this$lambdaType == null ? other$lambdaType != null : !this$lambdaType.equals(other$lambdaType)) return false;
                    final java.lang.Object this$lambdaMethodName = this.lambdaMethodName;
                    final java.lang.Object other$lambdaMethodName = other.lambdaMethodName;
                    if (this$lambdaMethodName == null ? other$lambdaMethodName != null : !this$lambdaMethodName.equals(other$lambdaMethodName)) return false;
                    final java.lang.Object this$lambdaMethod = this.lambdaMethod;
                    final java.lang.Object other$lambdaMethod = other.lambdaMethod;
                    if (this$lambdaMethod == null ? other$lambdaMethod != null : !this$lambdaMethod.equals(other$lambdaMethod)) return false;
                    final java.lang.Object this$targetMethod = this.targetMethod;
                    final java.lang.Object other$targetMethod = other.targetMethod;
                    if (this$targetMethod == null ? other$targetMethod != null : !this$targetMethod.equals(other$targetMethod)) return false;
                    final java.lang.Object this$specializedMethod = this.specializedMethod;
                    final java.lang.Object other$specializedMethod = other.specializedMethod;
                    if (this$specializedMethod == null ? other$specializedMethod != null : !this$specializedMethod.equals(other$specializedMethod)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.SerializationImplementation;
                }
                ...
                public int hashCode() {
                    ...
                    final java.lang.Object $lambdaType = this.lambdaType;
                    result = result * PRIME + ($lambdaType == null ? 43 : $lambdaType.hashCode());
                    final java.lang.Object $lambdaMethodName = this.lambdaMethodName;
                    result = result * PRIME + ($lambdaMethodName == null ? 43 : $lambdaMethodName.hashCode());
                    final java.lang.Object $lambdaMethod = this.lambdaMethod;
                    result = result * PRIME + ($lambdaMethod == null ? 43 : $lambdaMethod.hashCode());
                    final java.lang.Object $targetMethod = this.targetMethod;
                    result = result * PRIME + ($targetMethod == null ? 43 : $targetMethod.hashCode());
                    final java.lang.Object $specializedMethod = this.specializedMethod;
                    result = result * PRIME + ($specializedMethod == null ? 43 : $specializedMethod.hashCode());
                    return result;
                }
            }
            ...
            protected static class BridgeMethodImplementation implements Implementation {
                ...
                protected static class Appender implements ByteCodeAppender {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.BridgeMethodImplementation.Appender)) return false;
                        final AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.BridgeMethodImplementation.Appender other = (AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.BridgeMethodImplementation.Appender) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$bridgeTargetInvocation = this.bridgeTargetInvocation;
                        final java.lang.Object other$bridgeTargetInvocation = other.bridgeTargetInvocation;
                        if (this$bridgeTargetInvocation == null ? other$bridgeTargetInvocation != null : !this$bridgeTargetInvocation.equals(other$bridgeTargetInvocation)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.BridgeMethodImplementation.Appender;
                    }
                    ...
                    public int hashCode() {
                        final int PRIME = 59;
                        int result = 1;
                        final java.lang.Object $bridgeTargetInvocation = this.bridgeTargetInvocation;
                        result = result * PRIME + ($bridgeTargetInvocation == null ? 43 : $bridgeTargetInvocation.hashCode());
                        return result;
                    }
                }
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.BridgeMethodImplementation)) return false;
                    final AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.BridgeMethodImplementation other = (AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.BridgeMethodImplementation) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$lambdaMethodName = this.lambdaMethodName;
                    final java.lang.Object other$lambdaMethodName = other.lambdaMethodName;
                    if (this$lambdaMethodName == null ? other$lambdaMethodName != null : !this$lambdaMethodName.equals(other$lambdaMethodName)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory.BridgeMethodImplementation;
                }
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory)) return false;
                final AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory other = (AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$byteBuddy = this.byteBuddy;
                final java.lang.Object other$byteBuddy = other.byteBuddy;
                if (this$byteBuddy == null ? other$byteBuddy != null : !this$byteBuddy.equals(other$byteBuddy)) return false;
                return true;
            }
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof AgentBuilder.LambdaInstrumentationStrategy.LambdaInstanceFactory;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $byteBuddy = this.byteBuddy;
                result = result * PRIME + ($byteBuddy == null ? 43 : $byteBuddy.hashCode());
                return result;
            }
        }
         ...
         * (byte[]) ClassLoader.getSystemClassLoader().loadClass("LambdaFactory").getDeclaredMethod("make",
         * Object.class,
         * String.class,
         * Object.class,
         * Object.class,
    ...
    /**
     * <p>
     * The default implementation of an {@link AgentBuilder}.
     * </p>
     * <p>
    ...
    class Default implements AgentBuilder {
        ...
        /**
         * The {@link ByteBuddy} instance to be used.
         */
        ...
        /**
         * Creates a new default agent builder that uses a default {@link ByteBuddy} instance for creating classes.
         */
        public Default() {
            this(new ByteBuddy());
        }
        ...
        public Default(ByteBuddy byteBuddy) {
            this(byteBuddy, Listener.NoOp.INSTANCE, DEFAULT_LOCK, PoolStrategy.Default.FAST, TypeStrategy.Default.REBASE, LocationStrategy.ForClassLoader.STRONG, NativeMethodStrategy.Disabled.INSTANCE, new InitializationStrategy.SelfInjection.Split(), RedefinitionStrategy.DISABLED, RedefinitionStrategy.BatchAllocator.ForTotal.INSTANCE, RedefinitionStrategy.Listener.NoOp.INSTANCE, RedefinitionStrategy.ResubmissionStrategy.Disabled.INSTANCE, BootstrapInjectionStrategy.Disabled.INSTANCE, LambdaInstrumentationStrategy.DISABLED, DescriptionStrategy.Default.HYBRID, InstallationStrategy.Default.ESCALATING, FallbackStrategy.ByThrowableType.ofOptionalTypes(), new RawMatcher.Disjunction(new RawMatcher.ForElementMatchers(ElementMatchers.any(), ElementMatchers.isBootstrapClassLoader()),
                    new RawMatcher.ForElementMatchers(ElementMatchers.nameStartsWith("net.bytebuddy.")
                            .or(ElementMatchers.nameStartsWith("scouter.bytebuddy."))
                            .or(ElementMatchers.nameStartsWith("sun.reflect.")).<TypeDescription>or(ElementMatchers.isSynthetic()))), Transformation.Ignored.INSTANCE);
        }
        ...
        public AgentBuilder with(ByteBuddy byteBuddy) {
            return new Default(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }

        @Override
        public AgentBuilder with(Listener listener) {
            return new Default(byteBuddy, new Listener.Compound(this.listener, listener), circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }
        ...
        public AgentBuilder enableNativeMethodPrefix(String prefix) {
            return new Default(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, NativeMethodStrategy.ForPrefix.of(prefix), initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }

        @Override
        public AgentBuilder disableNativeMethodPrefix() {
            return new Default(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, NativeMethodStrategy.Disabled.INSTANCE, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }

        @Override
        public RedefinitionListenable.WithoutBatchStrategy with(RedefinitionStrategy redefinitionStrategy) {
            return new Redefining(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, RedefinitionStrategy.BatchAllocator.ForTotal.INSTANCE, RedefinitionStrategy.Listener.NoOp.INSTANCE, RedefinitionStrategy.ResubmissionStrategy.Disabled.INSTANCE, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }
        ...
        public AgentBuilder enableBootstrapInjection(Instrumentation instrumentation, File folder) {
            return new Default(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, new BootstrapInjectionStrategy.Enabled(folder, instrumentation), lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }

        @Override
        public AgentBuilder enableUnsafeBootstrapInjection() {
            return new Default(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, BootstrapInjectionStrategy.Unsafe.INSTANCE, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }

        @Override
        public AgentBuilder disableBootstrapInjection() {
            return new Default(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, BootstrapInjectionStrategy.Disabled.INSTANCE, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }

        @Override
        public AgentBuilder disableClassFormatChanges() {
            return new Default(byteBuddy.with(Implementation.Context.Disabled.Factory.INSTANCE), listener, circularityLock, poolStrategy, TypeStrategy.Default.REDEFINE_FROZEN, locationStrategy, NativeMethodStrategy.Disabled.INSTANCE, InitializationStrategy.NoOp.INSTANCE, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
        }
        ...
        private ResettableClassFileTransformer makeRaw(Listener listener) {
            return ExecutingTransformer.FACTORY.make(byteBuddy, listener, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, fallbackStrategy, ignoredTypeMatcher, transformation, circularityLock);
        }
        ...
        public ResettableClassFileTransformer installOn(Instrumentation instrumentation) {
            ...
            try {
                Listener listener = redefinitionResubmissionStrategy.onInstall(instrumentation, locationStrategy, this.listener, circularityLock, new RawMatcher.Conjunction(new RawMatcher.Inversion(ignoredTypeMatcher), transformation), redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener);
                ...
                try {
                    ...
                    if (redefinitionStrategy.isEnabled()) {
                        redefinitionStrategy.apply(instrumentation, listener, circularityLock, poolStrategy, locationStrategy, redefinitionBatchAllocator, redefinitionListener, lambdaInstrumentationStrategy, descriptionStrategy, fallbackStrategy, transformation, ignoredTypeMatcher);
                    }
                    return classFileTransformer;
                } catch (Throwable throwable) {
        ...
        public ResettableClassFileTransformer installOnByteBuddyAgent() {
            try {
                return installOn((Instrumentation) ClassLoader.getSystemClassLoader().loadClass(INSTALLER_TYPE).getMethod(INSTRUMENTATION_GETTER).invoke(STATIC_MEMBER));
        ...
        protected interface BootstrapInjectionStrategy {
            ...
            class Enabled implements BootstrapInjectionStrategy {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.Default.BootstrapInjectionStrategy.Enabled)) return false;
                    final AgentBuilder.Default.BootstrapInjectionStrategy.Enabled other = (AgentBuilder.Default.BootstrapInjectionStrategy.Enabled) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.Default.BootstrapInjectionStrategy.Enabled;
                }
        ...
        protected interface NativeMethodStrategy {
            ...
            class ForPrefix implements NativeMethodStrategy {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.Default.NativeMethodStrategy.ForPrefix)) return false;
                    final AgentBuilder.Default.NativeMethodStrategy.ForPrefix other = (AgentBuilder.Default.NativeMethodStrategy.ForPrefix) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.Default.NativeMethodStrategy.ForPrefix;
                }
        ...
        protected interface Transformation extends RawMatcher {
             ...
             */
            Resolution resolve(TypeDescription typeDescription, ClassLoader classLoader, JavaModule module, Class<?> classBeingRedefined, boolean loaded, ProtectionDomain protectionDomain, TypePool typePool);
            ...
            interface Resolution {
                 ...
                 */
                byte[] apply(InitializationStrategy initializationStrategy, ClassFileLocator classFileLocator, TypeStrategy typeStrategy, ByteBuddy byteBuddy, NativeMethodStrategy methodNameTransformer, BootstrapInjectionStrategy bootstrapInjectionStrategy, AccessControlContext accessControlContext, Listener listener);
                ...
                class Unresolved implements Resolution {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.Default.Transformation.Resolution.Unresolved)) return false;
                        final AgentBuilder.Default.Transformation.Resolution.Unresolved other = (AgentBuilder.Default.Transformation.Resolution.Unresolved) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.Default.Transformation.Resolution.Unresolved;
                    }
                    ...
                    public int hashCode() {
                        ...
                        result = result * PRIME + (this.loaded ? 79 : 97);
                        return result;
                    }
                }
            }
            ...
            enum Ignored implements Transformation {
                ...
                @Override
                public Resolution resolve(TypeDescription typeDescription, ClassLoader classLoader, JavaModule module, Class<?> classBeingRedefined, boolean loaded, ProtectionDomain protectionDomain, TypePool typePool) {
            ...
            class Simple implements Transformation {
                ...
                @Override
                public Transformation.Resolution resolve(TypeDescription typeDescription, ClassLoader classLoader, JavaModule module, Class<?> classBeingRedefined, boolean loaded, ProtectionDomain protectionDomain, TypePool typePool) {
                    return matches(typeDescription, classLoader, module, classBeingRedefined, protectionDomain) ? new Resolution(typeDescription, classLoader, module, protectionDomain, loaded, typePool, transformer, decorator) : new Transformation.Resolution.Unresolved(typeDescription, classLoader, module, loaded);
                }
                ...
                protected static class Resolution implements Transformation.Resolution.Decoratable {
                     ...
                     * @param decorator        {@code true} if this transformer serves as a decorator.
                     */
                    protected Resolution(TypeDescription typeDescription, ClassLoader classLoader, JavaModule module, ProtectionDomain protectionDomain, boolean loaded, TypePool typePool, Transformer transformer, boolean decorator) {
                        this.typeDescription = typeDescription;
                        this.classLoader = classLoader;
                        this.module = module;
                    ...
                    @Override
                    public Sort getSort() {
                        return decorator ? Sort.DECORATOR : Sort.TERMINAL;
                    }
                    ...
                    public Transformation.Resolution append(Transformer transformer) {
                        return new Resolution(typeDescription, classLoader, module, protectionDomain, loaded, typePool, new Transformer.Compound(this.transformer, transformer), decorator);
                    }

                    @Override
                    public byte[] apply(InitializationStrategy initializationStrategy, ClassFileLocator classFileLocator, TypeStrategy typeStrategy, ByteBuddy byteBuddy, NativeMethodStrategy methodNameTransformer, BootstrapInjectionStrategy bootstrapInjectionStrategy, AccessControlContext accessControlContext, Listener listener) {
                        InitializationStrategy.Dispatcher dispatcher = initializationStrategy.dispatcher();
                        DynamicType.Unloaded<?> dynamicType = dispatcher.apply(transformer.transform(typeStrategy.builder(typeDescription, byteBuddy, classFileLocator, methodNameTransformer.resolve()), typeDescription, classLoader, module)).make(TypeResolutionStrategy.Disabled.INSTANCE, typePool);
                    ...
                    protected static class BootstrapClassLoaderCapableInjectorFactory implements InitializationStrategy.Dispatcher.InjectorFactory {
                        ...
                        public ClassInjector resolve() {
                            return classLoader == null ? bootstrapInjectionStrategy.make(protectionDomain) : new ClassInjector.UsingReflection(classLoader, protectionDomain);
                        }
                        ...
                        public boolean equals(final java.lang.Object o) {
                            if (o == this) return true;
                            if (!(o instanceof AgentBuilder.Default.Transformation.Simple.Resolution.BootstrapClassLoaderCapableInjectorFactory)) return false;
                            final AgentBuilder.Default.Transformation.Simple.Resolution.BootstrapClassLoaderCapableInjectorFactory other = (AgentBuilder.Default.Transformation.Simple.Resolution.BootstrapClassLoaderCapableInjectorFactory) o;
                            if (!other.canEqual((java.lang.Object) this)) return false;
                            final java.lang.Object this$bootstrapInjectionStrategy = this.bootstrapInjectionStrategy;
                            final java.lang.Object other$bootstrapInjectionStrategy = other.bootstrapInjectionStrategy;
                            if (this$bootstrapInjectionStrategy == null ? other$bootstrapInjectionStrategy != null : !this$bootstrapInjectionStrategy.equals(other$bootstrapInjectionStrategy)) return false;
                            final java.lang.Object this$classLoader = this.classLoader;
                            final java.lang.Object other$classLoader = other.classLoader;
                            if (this$classLoader == null ? other$classLoader != null : !this$classLoader.equals(other$classLoader)) return false;
                        ...
                        @javax.annotation.Generated("lombok")
                        protected boolean canEqual(final java.lang.Object other) {
                            return other instanceof AgentBuilder.Default.Transformation.Simple.Resolution.BootstrapClassLoaderCapableInjectorFactory;
                        }
                        ...
                        public int hashCode() {
                            final int PRIME = 59;
                            int result = 1;
                            final java.lang.Object $bootstrapInjectionStrategy = this.bootstrapInjectionStrategy;
                            result = result * PRIME + ($bootstrapInjectionStrategy == null ? 43 : $bootstrapInjectionStrategy.hashCode());
                            final java.lang.Object $classLoader = this.classLoader;
                            result = result * PRIME + ($classLoader == null ? 43 : $classLoader.hashCode());
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.Default.Transformation.Simple.Resolution)) return false;
                        final AgentBuilder.Default.Transformation.Simple.Resolution other = (AgentBuilder.Default.Transformation.Simple.Resolution) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$typeDescription = this.typeDescription;
                        final java.lang.Object other$typeDescription = other.typeDescription;
                        if (this$typeDescription == null ? other$typeDescription != null : !this$typeDescription.equals(other$typeDescription)) return false;
                        ...
                        if (this.decorator != other.decorator) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.Default.Transformation.Simple.Resolution;
                    }
                    ...
                    public int hashCode() {
                        ...
                        result = result * PRIME + (this.decorator ? 79 : 97);
                        return result;
                    }
                }
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.Default.Transformation.Simple)) return false;
                    final AgentBuilder.Default.Transformation.Simple other = (AgentBuilder.Default.Transformation.Simple) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$rawMatcher = this.rawMatcher;
                    final java.lang.Object other$rawMatcher = other.rawMatcher;
                    if (this$rawMatcher == null ? other$rawMatcher != null : !this$rawMatcher.equals(other$rawMatcher)) return false;
                    final java.lang.Object this$transformer = this.transformer;
                    final java.lang.Object other$transformer = other.transformer;
                    if (this$transformer == null ? other$transformer != null : !this$transformer.equals(other$transformer)) return false;
                    if (this.decorator != other.decorator) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.Default.Transformation.Simple;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    final java.lang.Object $rawMatcher = this.rawMatcher;
                    result = result * PRIME + ($rawMatcher == null ? 43 : $rawMatcher.hashCode());
                    final java.lang.Object $transformer = this.transformer;
                    result = result * PRIME + ($transformer == null ? 43 : $transformer.hashCode());
                    result = result * PRIME + (this.decorator ? 79 : 97);
                    return result;
            ...
            class Compound implements Transformation {
                ...
                public Resolution resolve(TypeDescription typeDescription, ClassLoader classLoader, JavaModule module, Class<?> classBeingRedefined, boolean loaded, ProtectionDomain protectionDomain, TypePool typePool) {
                    ...
                    for (Transformation transformation : transformations) {
                        Resolution resolution = transformation.resolve(typeDescription, classLoader, module, classBeingRedefined, loaded, protectionDomain, typePool);
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof AgentBuilder.Default.Transformation.Compound)) return false;
                    final AgentBuilder.Default.Transformation.Compound other = (AgentBuilder.Default.Transformation.Compound) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$transformations = this.transformations;
                    final java.lang.Object other$transformations = other.transformations;
                    if (this$transformations == null ? other$transformations != null : !this$transformations.equals(other$transformations)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof AgentBuilder.Default.Transformation.Compound;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    final java.lang.Object $transformations = this.transformations;
                    result = result * PRIME + ($transformations == null ? 43 : $transformations.hashCode());
                    return result;
                }
            }
        }
        ...
        protected static class ExecutingTransformer extends ResettableClassFileTransformer.AbstractBase {
            ...
            private byte[] doTransform(JavaModule module, ClassLoader classLoader, String typeName, Class<?> classBeingRedefined, boolean loaded, ProtectionDomain protectionDomain, TypePool typePool, ClassFileLocator classFileLocator) {
                return resolve(module, classLoader, typeName, classBeingRedefined, loaded, protectionDomain, typePool).apply(initializationStrategy, classFileLocator, typeStrategy, byteBuddy, nativeMethodStrategy, bootstrapInjectionStrategy, accessControlContext, listener);
            }
             ...
             */
            private Transformation.Resolution resolve(JavaModule module, ClassLoader classLoader, String typeName, Class<?> classBeingRedefined, boolean loaded, ProtectionDomain protectionDomain, TypePool typePool) {
                ...
                return ignoredTypeMatcher.matches(typeDescription, classLoader, module, classBeingRedefined, protectionDomain) ? new Transformation.Resolution.Unresolved(typeDescription, classLoader, module, loaded) : transformation.resolve(typeDescription, classLoader, module, classBeingRedefined, loaded, protectionDomain, typePool);
            }

            @Override
            public synchronized boolean reset(Instrumentation instrumentation, RedefinitionStrategy redefinitionStrategy, RedefinitionStrategy.BatchAllocator redefinitionBatchAllocator, RedefinitionStrategy.Listener redefinitionListener) {
                if (instrumentation.removeTransformer(this)) {
                    redefinitionStrategy.apply(instrumentation, Listener.NoOp.INSTANCE, CircularityLock.Inactive.INSTANCE, poolStrategy, locationStrategy, redefinitionBatchAllocator, redefinitionListener, lambdaInstrumentationStrategy, descriptionStrategy, fallbackStrategy, transformation, ignoredTypeMatcher);
                    return true;
                } else {
                    return false;
                }
            ...
            protected interface Factory {
                 ...
                 */
                ResettableClassFileTransformer make(ByteBuddy byteBuddy, Listener listener, PoolStrategy poolStrategy, TypeStrategy typeStrategy, LocationStrategy locationStrategy, NativeMethodStrategy nativeMethodStrategy, InitializationStrategy initializationStrategy, BootstrapInjectionStrategy bootstrapInjectionStrategy, LambdaInstrumentationStrategy lambdaInstrumentationStrategy, DescriptionStrategy descriptionStrategy, FallbackStrategy fallbackStrategy, RawMatcher ignoredTypeMatcher, Transformation transformation, CircularityLock circularityLock);
                ...
                class ForJava9CapableVm implements Factory {
                    ...
                    public ResettableClassFileTransformer make(ByteBuddy byteBuddy, Listener listener, PoolStrategy poolStrategy, TypeStrategy typeStrategy, LocationStrategy locationStrategy, NativeMethodStrategy nativeMethodStrategy, InitializationStrategy initializationStrategy, BootstrapInjectionStrategy bootstrapInjectionStrategy, LambdaInstrumentationStrategy lambdaInstrumentationStrategy, DescriptionStrategy descriptionStrategy, FallbackStrategy fallbackStrategy, RawMatcher ignoredTypeMatcher, Transformation transformation, CircularityLock circularityLock) {
                        try {
                            return executingTransformer.newInstance(byteBuddy, listener, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, fallbackStrategy, ignoredTypeMatcher, transformation, circularityLock);
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof AgentBuilder.Default.ExecutingTransformer.Factory.ForJava9CapableVm)) return false;
                        final AgentBuilder.Default.ExecutingTransformer.Factory.ForJava9CapableVm other = (AgentBuilder.Default.ExecutingTransformer.Factory.ForJava9CapableVm) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$executingTransformer = this.executingTransformer;
                        final java.lang.Object other$executingTransformer = other.executingTransformer;
                        if (this$executingTransformer == null ? other$executingTransformer != null : !this$executingTransformer.equals(other$executingTransformer)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof AgentBuilder.Default.ExecutingTransformer.Factory.ForJava9CapableVm;
                    }
                    ...
                    public int hashCode() {
                        final int PRIME = 59;
                        int result = 1;
                        final java.lang.Object $executingTransformer = this.executingTransformer;
                        result = result * PRIME + ($executingTransformer == null ? 43 : $executingTransformer.hashCode());
                        return result;
                    }
                }
            ...
            protected class Java9CapableVmDispatcher implements PrivilegedAction<byte[]> {
                ...
                @Override
                public byte[] run() {
                    return transform(JavaModule.of(rawModule), classLoader, internalTypeName, classBeingRedefined, protectionDomain, binaryRepresentation);
                }
        ...
        protected abstract class Delegator<T extends Matchable<T>> extends Matchable.AbstractBase<T> implements AgentBuilder {
            /**
             * Materializes the currently described {@link AgentBuilder}.
             *
        ...
        protected class Ignoring extends Delegator<Ignored> implements Ignored {
            ...
            protected AgentBuilder materialize() {
                return new Default(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, rawMatcher, transformation);
            }
            ...
            public boolean equals(Object other) {
                return this == other || !(other == null || getClass() != other.getClass()) && rawMatcher.equals(((Ignoring) other).rawMatcher) && Default.this.equals(((Ignoring) other).getOuter());
            }
        ...
        protected static class Redefining extends Default implements RedefinitionListenable.WithoutBatchStrategy {
            ...
            public RedefinitionListenable with(RedefinitionStrategy.BatchAllocator redefinitionBatchAllocator) {
                ...
                return new Redefining(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
            }
            ...
            public RedefinitionListenable with(RedefinitionStrategy.Listener redefinitionListener) {
                ...
                return new Redefining(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, new RedefinitionStrategy.Listener.Compound(this.redefinitionListener, redefinitionListener), redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
            }
            ...
            public AgentBuilder withResubmission(RedefinitionStrategy.ResubmissionScheduler resubmissionScheduler, ElementMatcher<? super Throwable> matcher) {
                ...
                return new Redefining(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, new RedefinitionStrategy.ResubmissionStrategy.Enabled(resubmissionScheduler, matcher), bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, transformation);
            }
        }

        /**
         * A helper class that describes a {@link AgentBuilder.Default} after supplying
         * a {@link AgentBuilder.RawMatcher} such that one or several
         * {@link AgentBuilder.Transformer}s can be supplied.
         */
        protected class Transforming extends Delegator<Identified.Narrowable> implements Identified.Extendable, Identified.Narrowable {
            ...
            @Override
            protected AgentBuilder materialize() {
                return new Default(byteBuddy, listener, circularityLock, poolStrategy, typeStrategy, locationStrategy, nativeMethodStrategy, initializationStrategy, redefinitionStrategy, redefinitionBatchAllocator, redefinitionListener, redefinitionResubmissionStrategy, bootstrapInjectionStrategy, lambdaInstrumentationStrategy, descriptionStrategy, installationStrategy, fallbackStrategy, ignoredTypeMatcher, new Transformation.Compound(new Transformation.Simple(rawMatcher, transformer, decorator), transformation));
            }
            ...
            @Override
            public boolean equals(Object other) {
                return this == other || !(other == null || getClass() != other.getClass()) && decorator == ((Transforming) other).decorator && rawMatcher.equals(((Transforming) other).rawMatcher) && transformer.equals(((Transforming) other).transformer) && Default.this.equals(((Transforming) other).getOuter());
            }
        ...
        public boolean equals(final java.lang.Object o) {
            if (o == this) return true;
            if (!(o instanceof AgentBuilder.Default)) return false;
            final AgentBuilder.Default other = (AgentBuilder.Default) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
            final java.lang.Object this$byteBuddy = this.byteBuddy;
            final java.lang.Object other$byteBuddy = other.byteBuddy;
            if (this$byteBuddy == null ? other$byteBuddy != null : !this$byteBuddy.equals(other$byteBuddy)) return false;
            final java.lang.Object this$listener = this.listener;
            final java.lang.Object other$listener = other.listener;
            ...
            final java.lang.Object other$poolStrategy = other.poolStrategy;
            if (this$poolStrategy == null ? other$poolStrategy != null : !this$poolStrategy.equals(other$poolStrategy)) return false;
            final java.lang.Object this$typeStrategy = this.typeStrategy;
            final java.lang.Object other$typeStrategy = other.typeStrategy;
            if (this$typeStrategy == null ? other$typeStrategy != null : !this$typeStrategy.equals(other$typeStrategy)) return false;
            final java.lang.Object this$locationStrategy = this.locationStrategy;
            final java.lang.Object other$locationStrategy = other.locationStrategy;
            if (this$locationStrategy == null ? other$locationStrategy != null : !this$locationStrategy.equals(other$locationStrategy)) return false;
            final java.lang.Object this$nativeMethodStrategy = this.nativeMethodStrategy;
            final java.lang.Object other$nativeMethodStrategy = other.nativeMethodStrategy;
            if (this$nativeMethodStrategy == null ? other$nativeMethodStrategy != null : !this$nativeMethodStrategy.equals(other$nativeMethodStrategy)) return false;
            final java.lang.Object this$initializationStrategy = this.initializationStrategy;
            final java.lang.Object other$initializationStrategy = other.initializationStrategy;
            if (this$initializationStrategy == null ? other$initializationStrategy != null : !this$initializationStrategy.equals(other$initializationStrategy)) return false;
            final java.lang.Object this$redefinitionStrategy = this.redefinitionStrategy;
            final java.lang.Object other$redefinitionStrategy = other.redefinitionStrategy;
            if (this$redefinitionStrategy == null ? other$redefinitionStrategy != null : !this$redefinitionStrategy.equals(other$redefinitionStrategy)) return false;
            final java.lang.Object this$redefinitionBatchAllocator = this.redefinitionBatchAllocator;
            final java.lang.Object other$redefinitionBatchAllocator = other.redefinitionBatchAllocator;
            if (this$redefinitionBatchAllocator == null ? other$redefinitionBatchAllocator != null : !this$redefinitionBatchAllocator.equals(other$redefinitionBatchAllocator)) return false;
            final java.lang.Object this$redefinitionListener = this.redefinitionListener;
            final java.lang.Object other$redefinitionListener = other.redefinitionListener;
            if (this$redefinitionListener == null ? other$redefinitionListener != null : !this$redefinitionListener.equals(other$redefinitionListener)) return false;
            final java.lang.Object this$redefinitionResubmissionStrategy = this.redefinitionResubmissionStrategy;
            final java.lang.Object other$redefinitionResubmissionStrategy = other.redefinitionResubmissionStrategy;
            if (this$redefinitionResubmissionStrategy == null ? other$redefinitionResubmissionStrategy != null : !this$redefinitionResubmissionStrategy.equals(other$redefinitionResubmissionStrategy)) return false;
            final java.lang.Object this$bootstrapInjectionStrategy = this.bootstrapInjectionStrategy;
            final java.lang.Object other$bootstrapInjectionStrategy = other.bootstrapInjectionStrategy;
            if (this$bootstrapInjectionStrategy == null ? other$bootstrapInjectionStrategy != null : !this$bootstrapInjectionStrategy.equals(other$bootstrapInjectionStrategy)) return false;
            final java.lang.Object this$lambdaInstrumentationStrategy = this.lambdaInstrumentationStrategy;
            final java.lang.Object other$lambdaInstrumentationStrategy = other.lambdaInstrumentationStrategy;
            if (this$lambdaInstrumentationStrategy == null ? other$lambdaInstrumentationStrategy != null : !this$lambdaInstrumentationStrategy.equals(other$lambdaInstrumentationStrategy)) return false;
            final java.lang.Object this$descriptionStrategy = this.descriptionStrategy;
            final java.lang.Object other$descriptionStrategy = other.descriptionStrategy;
            if (this$descriptionStrategy == null ? other$descriptionStrategy != null : !this$descriptionStrategy.equals(other$descriptionStrategy)) return false;
            final java.lang.Object this$installationStrategy = this.installationStrategy;
            final java.lang.Object other$installationStrategy = other.installationStrategy;
            if (this$installationStrategy == null ? other$installationStrategy != null : !this$installationStrategy.equals(other$installationStrategy)) return false;
            final java.lang.Object this$fallbackStrategy = this.fallbackStrategy;
            final java.lang.Object other$fallbackStrategy = other.fallbackStrategy;
            ...
            final java.lang.Object this$ignoredTypeMatcher = this.ignoredTypeMatcher;
            final java.lang.Object other$ignoredTypeMatcher = other.ignoredTypeMatcher;
            if (this$ignoredTypeMatcher == null ? other$ignoredTypeMatcher != null : !this$ignoredTypeMatcher.equals(other$ignoredTypeMatcher)) return false;
            final java.lang.Object this$transformation = this.transformation;
            final java.lang.Object other$transformation = other.transformation;
            if (this$transformation == null ? other$transformation != null : !this$transformation.equals(other$transformation)) return false;
            return true;
        }
        ...
        @javax.annotation.Generated("lombok")
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof AgentBuilder.Default;
        }
        ...
        public int hashCode() {
            ...
            final java.lang.Object $byteBuddy = this.byteBuddy;
            result = result * PRIME + ($byteBuddy == null ? 43 : $byteBuddy.hashCode());
            final java.lang.Object $listener = this.listener;
            result = result * PRIME + ($listener == null ? 43 : $listener.hashCode());
            final java.lang.Object $circularityLock = this.circularityLock;
            result = result * PRIME + ($circularityLock == null ? 43 : $circularityLock.hashCode());
            final java.lang.Object $poolStrategy = this.poolStrategy;
            result = result * PRIME + ($poolStrategy == null ? 43 : $poolStrategy.hashCode());
            final java.lang.Object $typeStrategy = this.typeStrategy;
            result = result * PRIME + ($typeStrategy == null ? 43 : $typeStrategy.hashCode());
            final java.lang.Object $locationStrategy = this.locationStrategy;
            result = result * PRIME + ($locationStrategy == null ? 43 : $locationStrategy.hashCode());
            final java.lang.Object $nativeMethodStrategy = this.nativeMethodStrategy;
            result = result * PRIME + ($nativeMethodStrategy == null ? 43 : $nativeMethodStrategy.hashCode());
            final java.lang.Object $initializationStrategy = this.initializationStrategy;
            result = result * PRIME + ($initializationStrategy == null ? 43 : $initializationStrategy.hashCode());
            final java.lang.Object $redefinitionStrategy = this.redefinitionStrategy;
            result = result * PRIME + ($redefinitionStrategy == null ? 43 : $redefinitionStrategy.hashCode());
            final java.lang.Object $redefinitionBatchAllocator = this.redefinitionBatchAllocator;
            result = result * PRIME + ($redefinitionBatchAllocator == null ? 43 : $redefinitionBatchAllocator.hashCode());
            final java.lang.Object $redefinitionListener = this.redefinitionListener;
            result = result * PRIME + ($redefinitionListener == null ? 43 : $redefinitionListener.hashCode());
            final java.lang.Object $redefinitionResubmissionStrategy = this.redefinitionResubmissionStrategy;
            result = result * PRIME + ($redefinitionResubmissionStrategy == null ? 43 : $redefinitionResubmissionStrategy.hashCode());
            final java.lang.Object $bootstrapInjectionStrategy = this.bootstrapInjectionStrategy;
            result = result * PRIME + ($bootstrapInjectionStrategy == null ? 43 : $bootstrapInjectionStrategy.hashCode());
            final java.lang.Object $lambdaInstrumentationStrategy = this.lambdaInstrumentationStrategy;
            result = result * PRIME + ($lambdaInstrumentationStrategy == null ? 43 : $lambdaInstrumentationStrategy.hashCode());
            final java.lang.Object $descriptionStrategy = this.descriptionStrategy;
            result = result * PRIME + ($descriptionStrategy == null ? 43 : $descriptionStrategy.hashCode());
            final java.lang.Object $installationStrategy = this.installationStrategy;
            result = result * PRIME + ($installationStrategy == null ? 43 : $installationStrategy.hashCode());
            final java.lang.Object $fallbackStrategy = this.fallbackStrategy;
            result = result * PRIME + ($fallbackStrategy == null ? 43 : $fallbackStrategy.hashCode());
            final java.lang.Object $ignoredTypeMatcher = this.ignoredTypeMatcher;
            result = result * PRIME + ($ignoredTypeMatcher == null ? 43 : $ignoredTypeMatcher.hashCode());
            final java.lang.Object $transformation = this.transformation;
            result = result * PRIME + ($transformation == null ? 43 : $transformation.hashCode());
            return result;
        }
    }
}
