...
public class JavaModule implements NamedElement.WithOptionalName {
    ...
    protected interface Dispatcher {
        ...
        class Enabled implements Dispatcher {
             ...
             */
            protected Enabled(Method getModule, Method getClassLoader, Method isNamed, Method getName, Method getResourceAsStream, Method canRead, Method redefineModule) {
            ...
            public void addReads(Instrumentation instrumentation, Object source, Object target) {
                try {
                    redefineModule.invoke(instrumentation, source, Collections.singleton(target), Collections.emptyMap(), Collections.emptyMap(), Collections.emptySet(), Collections.emptyMap());
                } catch (IllegalAccessException exception) {
            ...
            public boolean equals(final java.lang.Object o) {
                ...
                if (!(o instanceof JavaModule.Dispatcher.Enabled)) return false;
                final JavaModule.Dispatcher.Enabled other = (JavaModule.Dispatcher.Enabled) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$getModule = this.getModule;
                final java.lang.Object other$getModule = other.getModule;
                if (this$getModule == null ? other$getModule != null : !this$getModule.equals(other$getModule)) return false;
                final java.lang.Object this$getClassLoader = this.getClassLoader;
                final java.lang.Object other$getClassLoader = other.getClassLoader;
                if (this$getClassLoader == null ? other$getClassLoader != null : !this$getClassLoader.equals(other$getClassLoader)) return false;
                final java.lang.Object this$isNamed = this.isNamed;
                final java.lang.Object other$isNamed = other.isNamed;
                if (this$isNamed == null ? other$isNamed != null : !this$isNamed.equals(other$isNamed)) return false;
                final java.lang.Object this$getName = this.getName;
                final java.lang.Object other$getName = other.getName;
                if (this$getName == null ? other$getName != null : !this$getName.equals(other$getName)) return false;
                final java.lang.Object this$getResourceAsStream = this.getResourceAsStream;
                final java.lang.Object other$getResourceAsStream = other.getResourceAsStream;
                if (this$getResourceAsStream == null ? other$getResourceAsStream != null : !this$getResourceAsStream.equals(other$getResourceAsStream)) return false;
                final java.lang.Object this$canRead = this.canRead;
                final java.lang.Object other$canRead = other.canRead;
                if (this$canRead == null ? other$canRead != null : !this$canRead.equals(other$canRead)) return false;
                final java.lang.Object this$redefineModule = this.redefineModule;
                final java.lang.Object other$redefineModule = other.redefineModule;
                if (this$redefineModule == null ? other$redefineModule != null : !this$redefineModule.equals(other$redefineModule)) return false;
                return true;
            }
            ...
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof JavaModule.Dispatcher.Enabled;
            }
            ...
            public int hashCode() {
                final int PRIME = 59;
                int result = 1;
                final java.lang.Object $getModule = this.getModule;
                result = result * PRIME + ($getModule == null ? 43 : $getModule.hashCode());
                final java.lang.Object $getClassLoader = this.getClassLoader;
                result = result * PRIME + ($getClassLoader == null ? 43 : $getClassLoader.hashCode());
                final java.lang.Object $isNamed = this.isNamed;
                result = result * PRIME + ($isNamed == null ? 43 : $isNamed.hashCode());
                final java.lang.Object $getName = this.getName;
                result = result * PRIME + ($getName == null ? 43 : $getName.hashCode());
                final java.lang.Object $getResourceAsStream = this.getResourceAsStream;
                result = result * PRIME + ($getResourceAsStream == null ? 43 : $getResourceAsStream.hashCode());
                final java.lang.Object $canRead = this.canRead;
                result = result * PRIME + ($canRead == null ? 43 : $canRead.hashCode());
                final java.lang.Object $redefineModule = this.redefineModule;
                result = result * PRIME + ($redefineModule == null ? 43 : $redefineModule.hashCode());
                return result;
            }
        }
