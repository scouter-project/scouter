 ...
 * {@link EnumerationDescription}s.</li>
...
public interface AnnotationDescription {
    ...
    class AnnotationInvocationHandler<T extends Annotation> implements InvocationHandler {
        ...
        public static <S extends Annotation> S of(ClassLoader classLoader, Class<S> annotationType, Map<String, ? extends AnnotationValue<?, ?>> values) throws ClassNotFoundException {
            ...
            for (Method method : annotationType.getDeclaredMethods()) {
                ...
                loadedValues.put(method, (annotationValue == null ? defaultValueOf(method) : annotationValue).load(classLoader));
            }
        ...
        private static AnnotationValue<?, ?> defaultValueOf(Method method) {
            ...
            return defaultValue == null ? MissingValue.of(method) : AnnotationDescription.ForLoadedAnnotation.asValue(defaultValue, method.getReturnType());
        }
    ...
    class ForLoadedAnnotation<S extends Annotation> extends AbstractBase.ForPrepared<S> {
        ...
        public <T extends Annotation> Loadable<T> prepare(Class<T> annotationType) {
            ...
            return annotationType == annotation.annotationType() ? (Loadable<T>) this : new ForLoadedAnnotation<T>((T) annotation, annotationType);
        }
