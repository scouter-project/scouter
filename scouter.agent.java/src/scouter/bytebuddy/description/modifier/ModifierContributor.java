...
public interface ModifierContributor {
    ...
    interface ForType extends ModifierContributor {
         ...
         */
        int MASK = Opcodes.ACC_PUBLIC | Opcodes.ACC_PROTECTED | Opcodes.ACC_PRIVATE | Opcodes.ACC_SYNTHETIC | Opcodes.ACC_ABSTRACT | Opcodes.ACC_INTERFACE | Opcodes.ACC_ANNOTATION | Opcodes.ACC_DEPRECATED | Opcodes.ACC_ENUM | Opcodes.ACC_FINAL | Opcodes.ACC_STATIC;
    }
    ...
    interface ForField extends ModifierContributor {
         ...
         */
        int MASK = Opcodes.ACC_PUBLIC | Opcodes.ACC_PROTECTED | Opcodes.ACC_PRIVATE | Opcodes.ACC_SYNTHETIC | Opcodes.ACC_DEPRECATED | Opcodes.ACC_ENUM | Opcodes.ACC_FINAL | Opcodes.ACC_STATIC | Opcodes.ACC_SYNTHETIC | Opcodes.ACC_TRANSIENT | Opcodes.ACC_VOLATILE;
    }
    ...
    interface ForMethod extends ModifierContributor {
         ...
         */
        int MASK = Opcodes.ACC_PUBLIC | Opcodes.ACC_PROTECTED | Opcodes.ACC_PRIVATE | Opcodes.ACC_SYNTHETIC | Opcodes.ACC_BRIDGE | Opcodes.ACC_FINAL | Opcodes.ACC_NATIVE | Opcodes.ACC_ABSTRACT | Opcodes.ACC_STATIC | Opcodes.ACC_STRICT | Opcodes.ACC_SYNCHRONIZED | Opcodes.ACC_SYNTHETIC | Opcodes.ACC_VARARGS;
    }
    ...
    class Resolver<T extends ModifierContributor> {
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof ModifierContributor.Resolver)) return false;
            final ModifierContributor.Resolver<?> other = (ModifierContributor.Resolver<?>) o;
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof ModifierContributor.Resolver;
        }
