...
public interface TypeDescription extends TypeDefinition, ByteCodeElement, TypeVariableSource {
    ...
    interface Generic extends TypeDefinition, AnnotatedCodeElement {
         ...
         * </p>
         * <p>
         * Only non-symbolic type variables ({@link scouter.bytebuddy.description.type.TypeDefinition.Sort#VARIABLE}, and wildcard types
         * ({@link scouter.bytebuddy.description.type.TypeDefinition.Sort#WILDCARD}) have well-defined upper bounds. For other
