...
public interface TypeDescription extends TypeDefinition, ByteCodeElement, TypeVariableSource {
    ...
    interface Generic extends TypeDefinition, AnnotationSource {
         ...
         * </p>
         * <p>
         * Only non-symbolic type variables ({@link TypeDefinition.Sort#VARIABLE}, and wildcard types
         * ({@link TypeDefinition.Sort#WILDCARD}) have well-defined upper bounds. For other
        ...
        interface Visitor<T> {
            ...
            enum AnnotationStripper implements Visitor<Generic> {
                ...
                public Generic onParameterizedType(Generic parameterizedType) {
                    ...
                    return new OfParameterizedType.Latent(parameterizedType.asErasure(), ownerType == null ? UNDEFINED : ownerType.accept(this), parameterizedType.getTypeArguments().accept(this), Empty.INSTANCE);
                }
                ...
                @Override
                public Generic onNonGenericType(Generic typeDescription) {
                    return typeDescription.isArray() ? new OfGenericArray.Latent(onNonGenericType(typeDescription.getComponentType()), Empty.INSTANCE) : new OfNonGenericType.Latent(typeDescription.asErasure(), Empty.INSTANCE);
                }
                ...
                public interface Dispatcher {
                    ...
                    class ForNonGenericType extends AbstractBase {
                        ...
                        public boolean equals(final java.lang.Object o) {
                            ...
                            if (!(o instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForNonGenericType)) return false;
                            final TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForNonGenericType other = (TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForNonGenericType) o;
                        ...
                        protected boolean canEqual(final java.lang.Object other) {
                            return other instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForNonGenericType;
                        }
                    ...
                    class ForTypeVariable extends AbstractBase {
                        ...
                        public boolean equals(final java.lang.Object o) {
                            if (o == this) return true;
                            if (!(o instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForTypeVariable)) return false;
                            final TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForTypeVariable other = (TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForTypeVariable) o;
                            if (!other.canEqual((java.lang.Object) this)) return false;
                            final java.lang.Object this$typeVariable = this.typeVariable;
                            final java.lang.Object other$typeVariable = other.typeVariable;
                            if (this$typeVariable == null ? other$typeVariable != null : !this$typeVariable.equals(other$typeVariable)) return false;
                            return true;
                        }
                        ...
                        @javax.annotation.Generated("lombok")
                        protected boolean canEqual(final java.lang.Object other) {
                            return other instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForTypeVariable;
                        }
                        ...
                        public int hashCode() {
                            final int PRIME = 59;
                            int result = 1;
                            final java.lang.Object $typeVariable = this.typeVariable;
                            result = result * PRIME + ($typeVariable == null ? 43 : $typeVariable.hashCode());
                            return result;
                        }
                    }
                    ...
                    class ForParameterizedType extends AbstractBase {
                        ...
                        protected enum ParameterAssigner implements Visitor<Dispatcher> {
                            ...
                            protected static class InvariantBinding implements Dispatcher {
                                ...
                                public boolean equals(final java.lang.Object o) {
                                    if (o == this) return true;
                                    if (!(o instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.InvariantBinding)) return false;
                                    final TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.InvariantBinding other = (TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.InvariantBinding) o;
                                    if (!other.canEqual((java.lang.Object) this)) return false;
                                    final java.lang.Object this$typeDescription = this.typeDescription;
                                    final java.lang.Object other$typeDescription = other.typeDescription;
                                    if (this$typeDescription == null ? other$typeDescription != null : !this$typeDescription.equals(other$typeDescription)) return false;
                                ...
                                @javax.annotation.Generated("lombok")
                                protected boolean canEqual(final java.lang.Object other) {
                                    return other instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.InvariantBinding;
                                }
                            ...
                            protected static class CovariantBinding implements Dispatcher {
                                ...
                                public boolean equals(final java.lang.Object o) {
                                    if (o == this) return true;
                                    if (!(o instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.CovariantBinding)) return false;
                                    final TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.CovariantBinding other = (TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.CovariantBinding) o;
                                    if (!other.canEqual((java.lang.Object) this)) return false;
                                    final java.lang.Object this$upperBound = this.upperBound;
                                    final java.lang.Object other$upperBound = other.upperBound;
                                    if (this$upperBound == null ? other$upperBound != null : !this$upperBound.equals(other$upperBound)) return false;
                                    return true;
                                }
                                ...
                                @javax.annotation.Generated("lombok")
                                protected boolean canEqual(final java.lang.Object other) {
                                    return other instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.CovariantBinding;
                                }
                                ...
                                public int hashCode() {
                                    final int PRIME = 59;
                                    int result = 1;
                                    final java.lang.Object $upperBound = this.upperBound;
                            ...
                            protected static class ContravariantBinding implements Dispatcher {
                                ...
                                public boolean equals(final java.lang.Object o) {
                                    if (o == this) return true;
                                    if (!(o instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.ContravariantBinding)) return false;
                                    final TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.ContravariantBinding other = (TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.ContravariantBinding) o;
                                    if (!other.canEqual((java.lang.Object) this)) return false;
                                    final java.lang.Object this$lowerBound = this.lowerBound;
                                    final java.lang.Object other$lowerBound = other.lowerBound;
                                    if (this$lowerBound == null ? other$lowerBound != null : !this$lowerBound.equals(other$lowerBound)) return false;
                                    return true;
                                }
                                ...
                                @javax.annotation.Generated("lombok")
                                protected boolean canEqual(final java.lang.Object other) {
                                    return other instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType.ParameterAssigner.ContravariantBinding;
                                }
                                ...
                                public int hashCode() {
                                    final int PRIME = 59;
                                    int result = 1;
                                    final java.lang.Object $lowerBound = this.lowerBound;
                        ...
                        public boolean equals(final java.lang.Object o) {
                            if (o == this) return true;
                            if (!(o instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType)) return false;
                            final TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType other = (TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType) o;
                            if (!other.canEqual((java.lang.Object) this)) return false;
                            final java.lang.Object this$parameterizedType = this.parameterizedType;
                            final java.lang.Object other$parameterizedType = other.parameterizedType;
                            if (this$parameterizedType == null ? other$parameterizedType != null : !this$parameterizedType.equals(other$parameterizedType)) return false;
                            return true;
                        }
                        ...
                        @javax.annotation.Generated("lombok")
                        protected boolean canEqual(final java.lang.Object other) {
                            return other instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForParameterizedType;
                        }
                        ...
                        public int hashCode() {
                            final int PRIME = 59;
                            int result = 1;
                            final java.lang.Object $parameterizedType = this.parameterizedType;
                            result = result * PRIME + ($parameterizedType == null ? 43 : $parameterizedType.hashCode());
                            return result;
                        }
                    }
                    ...
                    class ForGenericArray extends AbstractBase {
                        ...
                        @Override
                        public Boolean onNonGenericType(Generic typeDescription) {
                            return typeDescription.isArray() && genericArray.getComponentType().accept(Assigner.INSTANCE).isAssignableFrom(typeDescription.getComponentType());
                        }
                        ...
                        public boolean equals(final java.lang.Object o) {
                            if (o == this) return true;
                            if (!(o instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForGenericArray)) return false;
                            final TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForGenericArray other = (TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForGenericArray) o;
                            if (!other.canEqual((java.lang.Object) this)) return false;
                            final java.lang.Object this$genericArray = this.genericArray;
                            final java.lang.Object other$genericArray = other.genericArray;
                            if (this$genericArray == null ? other$genericArray != null : !this$genericArray.equals(other$genericArray)) return false;
                            return true;
                        }
                        ...
                        @javax.annotation.Generated("lombok")
                        protected boolean canEqual(final java.lang.Object other) {
                            return other instanceof TypeDescription.Generic.Visitor.Assigner.Dispatcher.ForGenericArray;
                        }
                        ...
                        public int hashCode() {
                            final int PRIME = 59;
                            int result = 1;
                            final java.lang.Object $genericArray = this.genericArray;
                            result = result * PRIME + ($genericArray == null ? 43 : $genericArray.hashCode());
                            return result;
                        }
                    }
                }
            ...
            enum Validator implements Visitor<Boolean> {
                ...
                @Override
                public Boolean onNonGenericType(Generic typeDescription) {
                    return (acceptsArray || !typeDescription.isArray()) && (acceptsPrimitive || !typeDescription.isPrimitive()) && (acceptsVoid || !typeDescription.represents(void.class));
                }
            ...
            class ForSignatureVisitor implements Visitor<SignatureVisitor> {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.Visitor.ForSignatureVisitor)) return false;
                    final TypeDescription.Generic.Visitor.ForSignatureVisitor other = (TypeDescription.Generic.Visitor.ForSignatureVisitor) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$signatureVisitor = this.signatureVisitor;
                    final java.lang.Object other$signatureVisitor = other.signatureVisitor;
                    if (this$signatureVisitor == null ? other$signatureVisitor != null : !this$signatureVisitor.equals(other$signatureVisitor)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.Visitor.ForSignatureVisitor;
                }
                ...
                public int hashCode() {
                    final int PRIME = 59;
                    int result = 1;
                    final java.lang.Object $signatureVisitor = this.signatureVisitor;
                    result = result * PRIME + ($signatureVisitor == null ? 43 : $signatureVisitor.hashCode());
                    return result;
                }
            }
            ...
            abstract class Substitutor implements Visitor<Generic> {
                ...
                public static class ForAttachment extends Substitutor {
                    ...
                    @Override
                    protected Generic onSimpleType(Generic typeDescription) {
                        return typeDescription.represents(TargetType.class) ? new OfNonGenericType.Latent(declaringType, typeDescription) : typeDescription;
                    }
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof TypeDescription.Generic.Visitor.Substitutor.ForAttachment)) return false;
                        final TypeDescription.Generic.Visitor.Substitutor.ForAttachment other = (TypeDescription.Generic.Visitor.Substitutor.ForAttachment) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        ...
                        final java.lang.Object this$typeVariableSource = this.typeVariableSource;
                        final java.lang.Object other$typeVariableSource = other.typeVariableSource;
                        if (this$typeVariableSource == null ? other$typeVariableSource != null : !this$typeVariableSource.equals(other$typeVariableSource)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof TypeDescription.Generic.Visitor.Substitutor.ForAttachment;
                    }
                    ...
                    public int hashCode() {
                        ...
                        final java.lang.Object $typeVariableSource = this.typeVariableSource;
                        result = result * PRIME + ($typeVariableSource == null ? 43 : $typeVariableSource.hashCode());
                        return result;
                    }
                }
                ...
                public static class ForDetachment extends Substitutor {
                    ...
                    @Override
                    protected Generic onSimpleType(Generic typeDescription) {
                        return typeMatcher.matches(typeDescription.asErasure()) ? new OfNonGenericType.Latent(TargetType.DESCRIPTION, typeDescription.getOwnerType(), typeDescription) : typeDescription;
                    }
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof TypeDescription.Generic.Visitor.Substitutor.ForDetachment)) return false;
                        final TypeDescription.Generic.Visitor.Substitutor.ForDetachment other = (TypeDescription.Generic.Visitor.Substitutor.ForDetachment) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof TypeDescription.Generic.Visitor.Substitutor.ForDetachment;
                    }
                ...
                public static class ForTypeVariableBinding extends WithoutTypeSubstitution {
                    ...
                    protected class TypeVariableSubstitutor implements TypeVariableSource.Visitor<Generic> {
                        ...
                        public Generic onType(TypeDescription typeDescription) {
                            ...
                            return typeArgument == null ? typeVariable.asRawType() : typeArgument;
                        }
                        ...
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && getOuter().equals(((TypeVariableSubstitutor) other).getOuter()) && typeVariable.equals(((TypeVariableSubstitutor) other).typeVariable);
                        }
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof TypeDescription.Generic.Visitor.Substitutor.ForTypeVariableBinding)) return false;
                        final TypeDescription.Generic.Visitor.Substitutor.ForTypeVariableBinding other = (TypeDescription.Generic.Visitor.Substitutor.ForTypeVariableBinding) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$parameterizedType = this.parameterizedType;
                        final java.lang.Object other$parameterizedType = other.parameterizedType;
                        if (this$parameterizedType == null ? other$parameterizedType != null : !this$parameterizedType.equals(other$parameterizedType)) return false;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof TypeDescription.Generic.Visitor.Substitutor.ForTypeVariableBinding;
                    }
                ...
                public static class ForTokenNormalization extends Substitutor {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof TypeDescription.Generic.Visitor.Substitutor.ForTokenNormalization)) return false;
                        final TypeDescription.Generic.Visitor.Substitutor.ForTokenNormalization other = (TypeDescription.Generic.Visitor.Substitutor.ForTokenNormalization) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$typeDescription = this.typeDescription;
                        final java.lang.Object other$typeDescription = other.typeDescription;
                        if (this$typeDescription == null ? other$typeDescription != null : !this$typeDescription.equals(other$typeDescription)) return false;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof TypeDescription.Generic.Visitor.Substitutor.ForTokenNormalization;
                    }
            ...
            class ForRawType implements Visitor<Generic> {
                ...
                @Override
                public Generic onGenericArray(Generic genericArray) {
                    return declaringType.isGenerified() ? new Generic.OfNonGenericType.Latent(genericArray.asErasure(), genericArray) : genericArray;
                }
                ...
                @Override
                public Generic onParameterizedType(Generic parameterizedType) {
                    return declaringType.isGenerified() ? new Generic.OfNonGenericType.Latent(parameterizedType.asErasure(), parameterizedType) : parameterizedType;
                }
            ...
            class Reducing implements Visitor<TypeDescription> {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.Visitor.Reducing)) return false;
                    final TypeDescription.Generic.Visitor.Reducing other = (TypeDescription.Generic.Visitor.Reducing) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$declaringType = this.declaringType;
                    final java.lang.Object other$declaringType = other.declaringType;
                    if (this$declaringType == null ? other$declaringType != null : !this$declaringType.equals(other$declaringType)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.Visitor.Reducing;
                }
        ...
        interface AnnotationReader {
            ...
            interface Dispatcher {
                ...
                enum CreationAction implements PrivilegedAction<Dispatcher> {
                    ...
                    public Dispatcher run() {
                        try {
                            return new ForJava8CapableVm(Class.class.getMethod("getAnnotatedSuperclass"), Class.class.getMethod("getAnnotatedInterfaces"), Field.class.getMethod("getAnnotatedType"), Method.class.getMethod("getAnnotatedReturnType"), Class.forName("java.lang.reflect.Executable").getMethod("getAnnotatedParameterTypes"), Class.forName("java.lang.reflect.Executable").getMethod("getAnnotatedExceptionTypes"), Class.forName("java.lang.reflect.Executable").getMethod("getAnnotatedReceiverType"), Class.forName("java.lang.reflect.AnnotatedType").getMethod("getType"));
                ...
                class ForJava8CapableVm implements Dispatcher {
                    ...
                    public Generic resolve(AnnotatedElement annotatedType) {
                        try {
                            return annotatedType == null ? UNDEFINED : Sort.describe((java.lang.reflect.Type) getType.invoke(annotatedType), new Resolved(annotatedType));
                        } catch (IllegalAccessException exception) {
                    ...
                    protected static class Resolved extends Delegator {
                        ...
                        public boolean equals(final java.lang.Object o) {
                            if (o == this) return true;
                            if (!(o instanceof TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm.Resolved)) return false;
                            final TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm.Resolved other = (TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm.Resolved) o;
                            if (!other.canEqual((java.lang.Object) this)) return false;
                            final java.lang.Object this$annotatedElement = this.annotatedElement;
                            final java.lang.Object other$annotatedElement = other.annotatedElement;
                            if (this$annotatedElement == null ? other$annotatedElement != null : !this$annotatedElement.equals(other$annotatedElement)) return false;
                            return true;
                        }
                        ...
                        @javax.annotation.Generated("lombok")
                        protected boolean canEqual(final java.lang.Object other) {
                            return other instanceof TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm.Resolved;
                        }
                        ...
                        public int hashCode() {
                            final int PRIME = 59;
                            int result = 1;
                            final java.lang.Object $annotatedElement = this.annotatedElement;
                            result = result * PRIME + ($annotatedElement == null ? 43 : $annotatedElement.hashCode());
                            return result;
                        }
                    }
                    ...
                    protected static class AnnotatedTypeVariableType extends Delegator {
                        ...
                        public boolean equals(final java.lang.Object o) {
                            if (o == this) return true;
                            if (!(o instanceof TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm.AnnotatedTypeVariableType)) return false;
                            final TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm.AnnotatedTypeVariableType other = (TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm.AnnotatedTypeVariableType) o;
                            if (!other.canEqual((java.lang.Object) this)) return false;
                            final java.lang.Object this$typeVariable = this.typeVariable;
                            final java.lang.Object other$typeVariable = other.typeVariable;
                            if (this$typeVariable == null ? other$typeVariable != null : !this$typeVariable.equals(other$typeVariable)) return false;
                        ...
                        @javax.annotation.Generated("lombok")
                        protected boolean canEqual(final java.lang.Object other) {
                            return other instanceof TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm.AnnotatedTypeVariableType;
                        }
                    ...
                    protected class AnnotatedSuperClass extends Delegator {
                        ...
                        @Override
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && getOuter().equals(((AnnotatedSuperClass) other).getOuter()) && type.equals(((AnnotatedSuperClass) other).type);
                        }
                    ...
                    protected class AnnotatedInterfaceType extends Delegator {
                        ...
                        @Override
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && getOuter().equals(((AnnotatedInterfaceType) other).getOuter()) && type.equals(((AnnotatedInterfaceType) other).type) && index == ((AnnotatedInterfaceType) other).index;
                        }
                    ...
                    protected class AnnotatedFieldType extends Delegator {
                        ...
                        @Override
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && getOuter().equals(((AnnotatedFieldType) other).getOuter()) && field.equals(((AnnotatedFieldType) other).field);
                        }
                    ...
                    protected class AnnotatedReturnType extends Delegator {
                        ...
                        @Override
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && getOuter().equals(((AnnotatedReturnType) other).getOuter()) && method.equals(((AnnotatedReturnType) other).method);
                        }
                    ...
                    protected class AnnotatedParameterizedType extends Delegator {
                        ...
                        @Override
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && getOuter().equals(((AnnotatedParameterizedType) other).getOuter()) && executable.equals(((AnnotatedParameterizedType) other).executable) && index == ((AnnotatedParameterizedType) other).index;
                        }
                    ...
                    protected class AnnotatedExceptionType extends Delegator {
                        ...
                        @Override
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && getOuter().equals(((AnnotatedExceptionType) other).getOuter()) && executable.equals(((AnnotatedExceptionType) other).executable) && index == ((AnnotatedExceptionType) other).index;
                        }
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm)) return false;
                        final TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm other = (TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$getAnnotatedSuperclass = this.getAnnotatedSuperclass;
                        final java.lang.Object other$getAnnotatedSuperclass = other.getAnnotatedSuperclass;
                        if (this$getAnnotatedSuperclass == null ? other$getAnnotatedSuperclass != null : !this$getAnnotatedSuperclass.equals(other$getAnnotatedSuperclass)) return false;
                        final java.lang.Object this$getAnnotatedInterfaces = this.getAnnotatedInterfaces;
                        final java.lang.Object other$getAnnotatedInterfaces = other.getAnnotatedInterfaces;
                        if (this$getAnnotatedInterfaces == null ? other$getAnnotatedInterfaces != null : !this$getAnnotatedInterfaces.equals(other$getAnnotatedInterfaces)) return false;
                        final java.lang.Object this$getAnnotatedType = this.getAnnotatedType;
                        final java.lang.Object other$getAnnotatedType = other.getAnnotatedType;
                        if (this$getAnnotatedType == null ? other$getAnnotatedType != null : !this$getAnnotatedType.equals(other$getAnnotatedType)) return false;
                        final java.lang.Object this$getAnnotatedReturnType = this.getAnnotatedReturnType;
                        final java.lang.Object other$getAnnotatedReturnType = other.getAnnotatedReturnType;
                        if (this$getAnnotatedReturnType == null ? other$getAnnotatedReturnType != null : !this$getAnnotatedReturnType.equals(other$getAnnotatedReturnType)) return false;
                        final java.lang.Object this$getAnnotatedParameterTypes = this.getAnnotatedParameterTypes;
                        final java.lang.Object other$getAnnotatedParameterTypes = other.getAnnotatedParameterTypes;
                        if (this$getAnnotatedParameterTypes == null ? other$getAnnotatedParameterTypes != null : !this$getAnnotatedParameterTypes.equals(other$getAnnotatedParameterTypes)) return false;
                        final java.lang.Object this$getAnnotatedExceptionTypes = this.getAnnotatedExceptionTypes;
                        final java.lang.Object other$getAnnotatedExceptionTypes = other.getAnnotatedExceptionTypes;
                        if (this$getAnnotatedExceptionTypes == null ? other$getAnnotatedExceptionTypes != null : !this$getAnnotatedExceptionTypes.equals(other$getAnnotatedExceptionTypes)) return false;
                        final java.lang.Object this$getAnnotatedReceiverType = this.getAnnotatedReceiverType;
                        final java.lang.Object other$getAnnotatedReceiverType = other.getAnnotatedReceiverType;
                        if (this$getAnnotatedReceiverType == null ? other$getAnnotatedReceiverType != null : !this$getAnnotatedReceiverType.equals(other$getAnnotatedReceiverType)) return false;
                        final java.lang.Object this$getType = this.getType;
                        final java.lang.Object other$getType = other.getType;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof TypeDescription.Generic.AnnotationReader.Dispatcher.ForJava8CapableVm;
                    }
                    ...
                    public int hashCode() {
                        final int PRIME = 59;
                        int result = 1;
                        final java.lang.Object $getAnnotatedSuperclass = this.getAnnotatedSuperclass;
                        result = result * PRIME + ($getAnnotatedSuperclass == null ? 43 : $getAnnotatedSuperclass.hashCode());
                        final java.lang.Object $getAnnotatedInterfaces = this.getAnnotatedInterfaces;
                        result = result * PRIME + ($getAnnotatedInterfaces == null ? 43 : $getAnnotatedInterfaces.hashCode());
                        final java.lang.Object $getAnnotatedType = this.getAnnotatedType;
                        result = result * PRIME + ($getAnnotatedType == null ? 43 : $getAnnotatedType.hashCode());
                        final java.lang.Object $getAnnotatedReturnType = this.getAnnotatedReturnType;
                        result = result * PRIME + ($getAnnotatedReturnType == null ? 43 : $getAnnotatedReturnType.hashCode());
                        final java.lang.Object $getAnnotatedParameterTypes = this.getAnnotatedParameterTypes;
                        result = result * PRIME + ($getAnnotatedParameterTypes == null ? 43 : $getAnnotatedParameterTypes.hashCode());
                        final java.lang.Object $getAnnotatedExceptionTypes = this.getAnnotatedExceptionTypes;
                        result = result * PRIME + ($getAnnotatedExceptionTypes == null ? 43 : $getAnnotatedExceptionTypes.hashCode());
                        final java.lang.Object $getAnnotatedReceiverType = this.getAnnotatedReceiverType;
                        result = result * PRIME + ($getAnnotatedReceiverType == null ? 43 : $getAnnotatedReceiverType.hashCode());
                        final java.lang.Object $getType = this.getType;
            ...
            abstract class Delegator implements AnnotationReader {
                ...
                protected static abstract class Chained extends Delegator {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof TypeDescription.Generic.AnnotationReader.Delegator.Chained)) return false;
                        final TypeDescription.Generic.AnnotationReader.Delegator.Chained other = (TypeDescription.Generic.AnnotationReader.Delegator.Chained) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$annotationReader = this.annotationReader;
                        final java.lang.Object other$annotationReader = other.annotationReader;
                        if (this$annotationReader == null ? other$annotationReader != null : !this$annotationReader.equals(other$annotationReader)) return false;
                        return true;
                    }
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof TypeDescription.Generic.AnnotationReader.Delegator.Chained;
                    }
                    ...
                    public int hashCode() {
                        final int PRIME = 59;
                        int result = 1;
                        final java.lang.Object $annotationReader = this.annotationReader;
                        result = result * PRIME + ($annotationReader == null ? 43 : $annotationReader.hashCode());
                        return result;
                    }
                }
            }
            ...
            class ForWildcardUpperBoundType extends Delegator.Chained {
                ...
                protected AnnotatedElement resolve(AnnotatedElement annotatedElement) {
                    try {
                        ...
                        return  // Wildcards with a lower bound do not define annotations for their implicit upper bound.
                        Array.getLength(annotatedUpperBounds) == 0 ? NoOp.INSTANCE : (AnnotatedElement) Array.get(annotatedUpperBounds, index);
                    } catch (ClassCastException ignored) {
                        // To avoid bug on early releases of Java 8.
                        return NoOp.INSTANCE;
                    } catch (IllegalAccessException exception) {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.AnnotationReader.ForWildcardUpperBoundType)) return false;
                    final TypeDescription.Generic.AnnotationReader.ForWildcardUpperBoundType other = (TypeDescription.Generic.AnnotationReader.ForWildcardUpperBoundType) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.AnnotationReader.ForWildcardUpperBoundType;
                }
            ...
            class ForWildcardLowerBoundType extends Delegator.Chained {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.AnnotationReader.ForWildcardLowerBoundType)) return false;
                    final TypeDescription.Generic.AnnotationReader.ForWildcardLowerBoundType other = (TypeDescription.Generic.AnnotationReader.ForWildcardLowerBoundType) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                    if (this.index != other.index) return false;
                    return true;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.AnnotationReader.ForWildcardLowerBoundType;
                }
            ...
            class ForTypeVariableBoundType extends Delegator.Chained {
                ...
                protected static class OfFormalTypeVariable extends Delegator {
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof TypeDescription.Generic.AnnotationReader.ForTypeVariableBoundType.OfFormalTypeVariable)) return false;
                        final TypeDescription.Generic.AnnotationReader.ForTypeVariableBoundType.OfFormalTypeVariable other = (TypeDescription.Generic.AnnotationReader.ForTypeVariableBoundType.OfFormalTypeVariable) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                        final java.lang.Object this$typeVariable = this.typeVariable;
                        final java.lang.Object other$typeVariable = other.typeVariable;
                        if (this$typeVariable == null ? other$typeVariable != null : !this$typeVariable.equals(other$typeVariable)) return false;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof TypeDescription.Generic.AnnotationReader.ForTypeVariableBoundType.OfFormalTypeVariable;
                    }
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.AnnotationReader.ForTypeVariableBoundType)) return false;
                    final TypeDescription.Generic.AnnotationReader.ForTypeVariableBoundType other = (TypeDescription.Generic.AnnotationReader.ForTypeVariableBoundType) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                    if (this.index != other.index) return false;
                    return true;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.AnnotationReader.ForTypeVariableBoundType;
                }
            ...
            class ForTypeArgument extends Delegator.Chained {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.AnnotationReader.ForTypeArgument)) return false;
                    final TypeDescription.Generic.AnnotationReader.ForTypeArgument other = (TypeDescription.Generic.AnnotationReader.ForTypeArgument) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                    if (this.index != other.index) return false;
                    return true;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.AnnotationReader.ForTypeArgument;
                }
        ...
        abstract class OfNonGenericType extends AbstractBase {
            ...
            public Generic getSuperClass() {
                ...
                return superClass == null ? Generic.UNDEFINED : new Generic.LazyProjection.WithResolvedErasure(superClass, new Visitor.ForRawType(erasure), Empty.INSTANCE);
            }
            ...
            public static class ForLoadedType extends OfNonGenericType {
                ...
                public Generic getOwnerType() {
                    ...
                    return declaringClass == null ? Generic.UNDEFINED : new ForLoadedType(declaringClass, annotationReader.ofOuterClass());
                }

                @Override
                public Generic getComponentType() {
                    Class<?> componentType = type.getComponentType();
                    return componentType == null ? Generic.UNDEFINED : new ForLoadedType(componentType, annotationReader.ofComponentType());
                }
        ...
        abstract class OfParameterizedType extends AbstractBase {
            ...
            protected enum RenderingDelegate {
                 ...
                 */
                protected static final RenderingDelegate CURRENT = ClassFileVersion.ofThisVm(ClassFileVersion.JAVA_V6).isAtLeast(ClassFileVersion.JAVA_V9) ? RenderingDelegate.JAVA_9_CAPABLE_VM : RenderingDelegate.LEGACY_VM;
            ...
            public static class ForLoadedType extends OfParameterizedType {
                ...
                public Generic getOwnerType() {
                    ...
                    return ownerType == null ? Generic.UNDEFINED : Sort.describe(ownerType, annotationReader.ofOwnerType());
                }
            ...
            public static class ForReifiedType extends OfParameterizedType {
                ...
                public Generic getOwnerType() {
                    Generic ownerType = parameterizedType.getOwnerType();
                    return ownerType == null ? Generic.UNDEFINED : ownerType.accept(Visitor.Reifying.INHERITING);
                }
        ...
        abstract class LazyProjection extends AbstractBase {
            ...
            public static class ForLoadedSuperClass extends LazyProjection.WithLazyNavigation.OfAnnotatedElement {
                ...
                protected Generic resolve() {
                    ...
                    return superClass == null ? Generic.UNDEFINED : Sort.describe(superClass, getAnnotationReader());
                }
        ...
        abstract class Builder {
            ...
            public static Builder parameterizedType(Class<?> rawType, java.lang.reflect.Type ownerType, List<? extends java.lang.reflect.Type> parameters) {
                return parameterizedType(new ForLoadedType(rawType), ownerType == null ? null : Sort.describe(ownerType), new TypeList.Generic.ForLoadedTypes(parameters));
            }
            ...
            protected static class OfNonGenericType extends Builder {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.Builder.OfNonGenericType)) return false;
                    final TypeDescription.Generic.Builder.OfNonGenericType other = (TypeDescription.Generic.Builder.OfNonGenericType) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                    final java.lang.Object this$typeDescription = this.typeDescription;
                    final java.lang.Object other$typeDescription = other.typeDescription;
                    if (this$typeDescription == null ? other$typeDescription != null : !this$typeDescription.equals(other$typeDescription)) return false;
                    final java.lang.Object this$ownerType = this.ownerType;
                    final java.lang.Object other$ownerType = other.ownerType;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.Builder.OfNonGenericType;
                }
                ...
                public int hashCode() {
                    ...
                    final java.lang.Object $typeDescription = this.typeDescription;
                    result = result * PRIME + ($typeDescription == null ? 43 : $typeDescription.hashCode());
                    final java.lang.Object $ownerType = this.ownerType;
            ...
            protected static class OfParameterizedType extends Builder {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.Builder.OfParameterizedType)) return false;
                    final TypeDescription.Generic.Builder.OfParameterizedType other = (TypeDescription.Generic.Builder.OfParameterizedType) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                    final java.lang.Object this$rawType = this.rawType;
                    final java.lang.Object other$rawType = other.rawType;
                    if (this$rawType == null ? other$rawType != null : !this$rawType.equals(other$rawType)) return false;
                    final java.lang.Object this$ownerType = this.ownerType;
                    final java.lang.Object other$ownerType = other.ownerType;
                    if (this$ownerType == null ? other$ownerType != null : !this$ownerType.equals(other$ownerType)) return false;
                    final java.lang.Object this$parameterTypes = this.parameterTypes;
                    final java.lang.Object other$parameterTypes = other.parameterTypes;
                    if (this$parameterTypes == null ? other$parameterTypes != null : !this$parameterTypes.equals(other$parameterTypes)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.Builder.OfParameterizedType;
                }
                ...
                public int hashCode() {
                    ...
                    int result = 1;
                    result = result * PRIME + super.hashCode();
                    final java.lang.Object $rawType = this.rawType;
                    result = result * PRIME + ($rawType == null ? 43 : $rawType.hashCode());
                    final java.lang.Object $ownerType = this.ownerType;
                    result = result * PRIME + ($ownerType == null ? 43 : $ownerType.hashCode());
                    final java.lang.Object $parameterTypes = this.parameterTypes;
                    result = result * PRIME + ($parameterTypes == null ? 43 : $parameterTypes.hashCode());
                    return result;
                }
            }
            ...
            protected static class OfGenericArrayType extends Builder {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.Builder.OfGenericArrayType)) return false;
                    final TypeDescription.Generic.Builder.OfGenericArrayType other = (TypeDescription.Generic.Builder.OfGenericArrayType) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.Builder.OfGenericArrayType;
                }
            ...
            protected static class OfTypeVariable extends Builder {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof TypeDescription.Generic.Builder.OfTypeVariable)) return false;
                    final TypeDescription.Generic.Builder.OfTypeVariable other = (TypeDescription.Generic.Builder.OfTypeVariable) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof TypeDescription.Generic.Builder.OfTypeVariable;
                }
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof TypeDescription.Generic.Builder)) return false;
                final TypeDescription.Generic.Builder other = (TypeDescription.Generic.Builder) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof TypeDescription.Generic.Builder;
            }
    ...
    abstract class AbstractBase extends TypeVariableSource.AbstractBase implements TypeDescription {
        ...
        public boolean isVisibleTo(TypeDescription typeDescription) {
            return isPrimitive() || (isArray() ? getComponentType().isVisibleTo(typeDescription) : isPublic() || isProtected() || isSamePackage(typeDescription)/* || equals(typeDescription.asErasure()) */);
        }

        @Override
        public boolean isAccessibleTo(TypeDescription typeDescription) {
            return isPrimitive() || (isArray() ? getComponentType().isVisibleTo(typeDescription) : isPublic() || isSamePackage(typeDescription)/* || equals(typeDescription.asErasure()) */);
        }
        ...
        public boolean isConstantPool() {
            return represents(int.class) || represents(long.class) || represents(float.class) || represents(double.class) || represents(String.class) || represents(Class.class) || JavaType.METHOD_HANDLE.getTypeStub().equals(this) || JavaType.METHOD_TYPE.getTypeStub().equals(this);
        }
        ...
        public TypeVariableSource getEnclosingSource() {
            ...
            return enclosingMethod == null ? (isStatic() ? TypeVariableSource.UNDEFINED : getEnclosingType()) // Top-level classes (non-static) have no enclosing type.
             : enclosingMethod;
        }
        ...
        @Override
        public boolean equals(Object other) {
            return other == this || other instanceof TypeDefinition && ((TypeDefinition) other).getSort().isNonGeneric() && getName().equals(((TypeDefinition) other).asErasure().getName());
        }
         ...
         */
        public static abstract class OfSimpleType extends TypeDescription.AbstractBase {
            @Override
            public boolean isPrimitive() {
                return false;
            }
            ...
            public String getCanonicalName() {
                return isAnonymousClass() || isLocalClass() ? NO_NAME : getName().replace('$', '.');
            }
    ...
    class ForLoadedType extends AbstractBase implements Serializable {
        ...
        @Override
        public Generic getSuperClass() {
            return type.getSuperclass() == null ? TypeDescription.Generic.UNDEFINED : new Generic.LazyProjection.ForLoadedSuperClass(type);
        }

        @Override
        public TypeList.Generic getInterfaces() {
            return isArray() ? ARRAY_INTERFACES : new TypeList.Generic.OfLoadedInterfaceTypes(type);
        }

        @Override
        public TypeDescription getDeclaringType() {
            Class<?> declaringType = type.getDeclaringClass();
            return declaringType == null ? TypeDescription.UNDEFINED : new ForLoadedType(declaringType);
        }
        ...
        public TypeDescription getEnclosingType() {
            ...
            return enclosingType == null ? TypeDescription.UNDEFINED : new ForLoadedType(enclosingType);
        }
        ...
        public String getDescriptor() {
            String name = type.getName();
            int anonymousLoaderIndex = name.indexOf('/');
            return anonymousLoaderIndex == -1 ? scouter.bytebuddy.jar.asm.Type.getDescriptor(type) : "L" + name.substring(0, anonymousLoaderIndex).replace('.', '/') + ";";
        }
    ...
    class ArrayProjection extends AbstractBase {
        ...
        @Override
        public TypeDescription getComponentType() {
            return arity == 1 ? componentType : new ArrayProjection(componentType, arity - 1);
        }
    ...
    class SuperTypeLoading extends AbstractBase {
        ...
        public Generic getSuperClass() {
            ...
            return superClass == null ? Generic.UNDEFINED : new ClassLoadingTypeProjection(superClass, classLoader, classLoadingDelegate);
        }
        ...
        protected static class ClassLoadingTypeProjection extends TypeDescription.Generic.LazyProjection {
            ...
            public Generic getSuperClass() {
                ...
                if (superClass == null) {
                    ...
                    try {
                        return new ClassLoadingTypeProjection(superClass, classLoadingDelegate.load(delegate.asErasure().getName(), classLoader).getClassLoader(), classLoadingDelegate);
                    } catch (ClassNotFoundException ignored) {
                        return superClass;
                    }
                }
            ...
            public TypeList.Generic getInterfaces() {
                ...
                try {
                    return new ClassLoadingTypeList(interfaces, classLoadingDelegate.load(delegate.asErasure().getName(), classLoader).getClassLoader(), classLoadingDelegate);
                } catch (ClassNotFoundException ignored) {
                    return interfaces;
                }
            }
