...
/**
 * This implementation returns a fixed value for a method. Other than the {@link StubMethod}
...
public abstract class FixedValue implements Implementation {
    ...
    /**
     * Other than {@link FixedValue#value(Object)}, this function
    ...
    protected static class ForOriginType extends FixedValue implements AssignerConfigurable {
        ...
        protected class Appender implements ByteCodeAppender {
            ...
            @Override
            public Size apply(MethodVisitor methodVisitor, Context implementationContext, MethodDescription instrumentedMethod) {
                return ForOriginType.this.apply(methodVisitor, implementationContext, instrumentedMethod, TypeDescription.CLASS.asGenericType(), ClassConstant.of(originType));
            }
    ...
    protected static class ForThisValue extends FixedValue implements AssignerConfigurable {
        ...
        protected static class Appender implements ByteCodeAppender {
            ...
            public boolean equals(final java.lang.Object o) {
                ...
                if (!(o instanceof FixedValue.ForThisValue.Appender)) return false;
                final FixedValue.ForThisValue.Appender other = (FixedValue.ForThisValue.Appender) o;
            ...
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof FixedValue.ForThisValue.Appender;
            }
    ...
    protected static class ForArgument extends FixedValue implements AssignerConfigurable, ByteCodeAppender {
        ...
        public boolean equals(final java.lang.Object o) {
            if (o == this) return true;
            if (!(o instanceof FixedValue.ForArgument)) return false;
            final FixedValue.ForArgument other = (FixedValue.ForArgument) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
        ...
        @javax.annotation.Generated("lombok")
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof FixedValue.ForArgument;
        }
