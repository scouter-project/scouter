 ...
 * the given ASM {@link scouter.bytebuddy.jar.asm.MethodVisitor}.
 * <p>&nbsp;</p>
 * The {@code ByteCodeAppender} is not allowed to write
 * annotations to the method or call the {@link scouter.bytebuddy.jar.asm.MethodVisitor#visitCode()},
 * {@link scouter.bytebuddy.jar.asm.MethodVisitor#visitMaxs(int, int)} or {@link scouter.bytebuddy.jar.asm.MethodVisitor#visitEnd()}
