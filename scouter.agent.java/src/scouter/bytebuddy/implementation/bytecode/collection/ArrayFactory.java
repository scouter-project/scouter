...
/**
 * A {@link scouter.bytebuddy.implementation.bytecode.collection.CollectionFactory} that is capable of
...
public class ArrayFactory implements CollectionFactory {
     ...
     * {@link scouter.bytebuddy.implementation.bytecode.collection.ArrayFactory.ArrayCreator}
     * without inferring the type from the component type. Normally,
     * {@link scouter.bytebuddy.implementation.bytecode.collection.ArrayFactory#forType(scouter.bytebuddy.description.type.TypeDescription.Generic)}
     * should be used.
     *
