 ...
 * {@link scouter.bytebuddy.implementation.bind.annotation.Pipe.Binder} needs to be installed explicitly
 * and registered on a {@link scouter.bytebuddy.implementation.MethodDelegation}. The installed type is allowed to be an
 ...
 * {@link scouter.bytebuddy.implementation.bind.annotation.Pipe.Binder} and register it on a
 * {@link scouter.bytebuddy.implementation.MethodDelegation}:
 * <pre>
 * MethodDelegation
...
public @interface Pipe {
    ...
    /**
     * A {@link scouter.bytebuddy.implementation.bind.annotation.TargetMethodAnnotationDrivenBinder.ParameterBinder}
     * for binding the {@link scouter.bytebuddy.implementation.bind.annotation.Pipe} annotation.
     */
    class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Pipe> {
         ...
         * {@link scouter.bytebuddy.implementation.bind.annotation.Pipe.Binder#install(Class)}
         * method.
         *
        ...
        /**
         * Installs a given type for use on a {@link scouter.bytebuddy.implementation.bind.annotation.Pipe}
         ...
         * @return A binder for the {@link scouter.bytebuddy.implementation.bind.annotation.Pipe}
         * annotation.
         */
         ...
         * {@link scouter.bytebuddy.implementation.bind.annotation.Pipe} annotation.
         */
        protected static class Redirection implements AuxiliaryType, StackManipulation {
             ...
             * {@link scouter.bytebuddy.implementation.bind.annotation.Pipe.Binder.Redirection}'s
             * constructor.
             */
            ...
            protected enum ConstructorCall implements Implementation {
                 ...
                 * {@link scouter.bytebuddy.implementation.bind.annotation.Pipe.Binder.Redirection.ConstructorCall}.
                 */
            ...
            protected static class MethodCall implements Implementation {
                ...
                /**
                 * The appender for implementing the
                 * {@link scouter.bytebuddy.implementation.bind.annotation.Pipe.Binder.Redirection.MethodCall}.
                 */
