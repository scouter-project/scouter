...
import static scouter.bytebuddy.matcher.ElementMatchers.isGetter;
import static scouter.bytebuddy.matcher.ElementMatchers.isSetter;

/**
 * This {@link scouter.bytebuddy.implementation.bind.MethodDelegationBinder} binds
...
public class TargetMethodAnnotationDrivenBinder implements MethodDelegationBinder {
     ...
     *                         {@link scouter.bytebuddy.implementation.bind.MethodDelegationBinder.ParameterBinding}
    ...
    public interface ParameterBinder<T extends Annotation> {
        ...
        abstract class ForFixedValue<S extends Annotation> implements ParameterBinder<S> {
            ...
            /**
             * Resolves a value for the given annotation on a parameter that is processed by a {@link scouter.bytebuddy.implementation.MethodDelegation}.
             *
            ...
            /**
             * <p>
             * A parameter binder that binds a fixed value to a parameter annotation when using a {@link scouter.bytebuddy.implementation.MethodDelegation}.
             * </p>
             * <p>
     ...
     * {@link scouter.bytebuddy.implementation.bind.annotation.TargetMethodAnnotationDrivenBinder}
    ...
    protected static class DelegationProcessor {
         ...
         *                         a {@link scouter.bytebuddy.implementation.bind.MethodDelegationBinder.ParameterBinding}
         *                         for a specific annotation.
        ...
        protected interface Handler {
            ...
            class Unbound implements Handler {
                ...
                /**
                 * A default implementation of an {@link scouter.bytebuddy.implementation.bind.annotation.Argument} annotation.
                 */
