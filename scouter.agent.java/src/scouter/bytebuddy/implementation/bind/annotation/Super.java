 ...
 * be assigned:
 * <ol>
 * <li>{@link Super.Instantiation#CONSTRUCTOR}:
 ...
 * <li>{@link Super.Instantiation#UNSAFE}:
...
public @interface Super {
    ...
    enum Instantiation {
        ...
        CONSTRUCTOR {
            ...
            protected StackManipulation proxyFor(TypeDescription parameterType, Implementation.Target implementationTarget, AnnotationDescription.Loadable<Super> annotation) {
                return new TypeProxy.ForSuperMethodByConstructor(parameterType, implementationTarget, Arrays.asList(annotation.getValue(CONSTRUCTOR_PARAMETERS).resolve(TypeDescription[].class)), annotation.getValue(IGNORE_FINALIZER).resolve(Boolean.class), annotation.getValue(SERIALIZABLE_PROXY).resolve(Boolean.class));
            }
        },
        /**
        ...
        static {
            ...
            IGNORE_FINALIZER = annotationProperties.filter(ElementMatchers.named("ignoreFinalizer")).getOnly();
            SERIALIZABLE_PROXY = annotationProperties.filter(ElementMatchers.named("serializableProxy")).getOnly();
            CONSTRUCTOR_PARAMETERS = annotationProperties.filter(ElementMatchers.named("constructorParameters")).getOnly();
        }
    ...
    enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Super> {
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> annotationProperties = new TypeDescription.ForLoadedType(Super.class).getDeclaredMethods();
            STRATEGY = annotationProperties.filter(ElementMatchers.named("strategy")).getOnly();
        ...
        protected interface TypeLocator {
            ...
            class ForType implements TypeLocator {
                ...
                public boolean equals(final java.lang.Object o) {
                    ...
                    if (!(o instanceof Super.Binder.TypeLocator.ForType)) return false;
                    final Super.Binder.TypeLocator.ForType other = (Super.Binder.TypeLocator.ForType) o;
                ...
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof Super.Binder.TypeLocator.ForType;
                }
