...
import scouter.bytebuddy.implementation.bind.annotation.Argument;
...
public enum ArgumentTypeResolver implements MethodDelegationBinder.AmbiguityResolver {
     ...
     */
    private static Resolution resolveRivalBinding(TypeDescription sourceParameterType, int leftParameterIndex, MethodDelegationBinder.MethodBinding left, int rightParameterIndex, MethodDelegationBinder.MethodBinding right) {
     ...
     * parameters that were bound by using an explicit {@link Argument}
     * annotation.
     *
    ...
    public Resolution resolve(MethodDescription source, MethodDelegationBinder.MethodBinding left, MethodDelegationBinder.MethodBinding right) {
        ...
        for (int sourceParameterIndex = 0; sourceParameterIndex < sourceParameters.size(); sourceParameterIndex++) {
            ...
            if (leftParameterIndex != null && rightParameterIndex != null) {
                resolution = resolution.merge(resolveRivalBinding(sourceParameters.get(sourceParameterIndex).getType().asErasure(), leftParameterIndex, left, rightParameterIndex, right));
     ...
     *
     * @see MethodDelegationBinder.MethodBinding#getTargetParameterIndex(Object)
     */
    public static class ParameterIndexToken {
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof ArgumentTypeResolver.ParameterIndexToken)) return false;
            final ArgumentTypeResolver.ParameterIndexToken other = (ArgumentTypeResolver.ParameterIndexToken) o;
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof ArgumentTypeResolver.ParameterIndexToken;
        }
