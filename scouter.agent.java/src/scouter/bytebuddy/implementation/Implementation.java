...
public interface Implementation extends InstrumentedType.Prepareable {
    ...
    interface SpecialMethodInvocation extends StackManipulation {
        ...
        abstract class AbstractBase implements SpecialMethodInvocation {
            ...
            public boolean equals(Object other) {
                ...
                return getMethodDescription().asSignatureToken().equals(specialMethodInvocation.getMethodDescription().asSignatureToken()) && getTypeDescription().equals(((SpecialMethodInvocation) other).getTypeDescription());
            }
        }
        ...
        class Simple extends SpecialMethodInvocation.AbstractBase {
            ...
            public static SpecialMethodInvocation of(MethodDescription methodDescription, TypeDescription typeDescription) {
                ...
                return stackManipulation.isValid() ? new Simple(methodDescription, typeDescription, stackManipulation) : SpecialMethodInvocation.Illegal.INSTANCE;
            }
    ...
    interface Target {
        ...
        abstract class AbstractBase implements Target {
            ...
            public boolean equals(final java.lang.Object o) {
                ...
                if (!(o instanceof Implementation.Target.AbstractBase)) return false;
                final Implementation.Target.AbstractBase other = (Implementation.Target.AbstractBase) o;
                ...
                final java.lang.Object this$defaultMethodInvocation = this.defaultMethodInvocation;
                final java.lang.Object other$defaultMethodInvocation = other.defaultMethodInvocation;
                if (this$defaultMethodInvocation == null ? other$defaultMethodInvocation != null : !this$defaultMethodInvocation.equals(other$defaultMethodInvocation)) return false;
                return true;
            }
            ...
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof Implementation.Target.AbstractBase;
            }
            ...
            public int hashCode() {
                ...
                final java.lang.Object $defaultMethodInvocation = this.defaultMethodInvocation;
                result = result * PRIME + ($defaultMethodInvocation == null ? 43 : $defaultMethodInvocation.hashCode());
                return result;
            }
        }
    }
     ...
     * sensitive as calling a {@link MethodVisitor}. As such, an implementation context and a
     * {@link MethodVisitor} are complementary for creating an new Java type.
     */
    interface Context extends MethodAccessorFactory {
        ...
        interface ExtractableView extends Context {
            ...
            /**
             * Returns any {@link AuxiliaryType} that was registered
            ...
            abstract class AbstractBase implements ExtractableView {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof Implementation.Context.ExtractableView.AbstractBase)) return false;
                    final Implementation.Context.ExtractableView.AbstractBase other = (Implementation.Context.ExtractableView.AbstractBase) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    final java.lang.Object this$instrumentedType = this.getInstrumentedType();
                    final java.lang.Object other$instrumentedType = other.getInstrumentedType();
                    if (this$instrumentedType == null ? other$instrumentedType != null : !this$instrumentedType.equals(other$instrumentedType)) return false;
                    final java.lang.Object this$classFileVersion = this.getClassFileVersion();
                    final java.lang.Object other$classFileVersion = other.getClassFileVersion();
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof Implementation.Context.ExtractableView.AbstractBase;
                }
                ...
                public int hashCode() {
                    ...
                    final java.lang.Object $instrumentedType = this.getInstrumentedType();
                    result = result * PRIME + ($instrumentedType == null ? 43 : $instrumentedType.hashCode());
                    final java.lang.Object $classFileVersion = this.getClassFileVersion();
        ...
        class Disabled extends ExtractableView.AbstractBase {
            ...
            /**
             * A factory for creating a {@link Implementation.Context.Disabled}.
             */
        ...
        class Default extends ExtractableView.AbstractBase {
            ...
            protected static class AccessorMethodDelegation extends DelegationRecord {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof Implementation.Context.Default.AccessorMethodDelegation)) return false;
                    final Implementation.Context.Default.AccessorMethodDelegation other = (Implementation.Context.Default.AccessorMethodDelegation) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                    final java.lang.Object this$accessorMethodInvocation = this.accessorMethodInvocation;
                    final java.lang.Object other$accessorMethodInvocation = other.accessorMethodInvocation;
                    if (this$accessorMethodInvocation == null ? other$accessorMethodInvocation != null : !this$accessorMethodInvocation.equals(other$accessorMethodInvocation)) return false;
                    return true;
                }
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof Implementation.Context.Default.AccessorMethodDelegation;
                }
                ...
                public int hashCode() {
                    ...
                    final java.lang.Object $accessorMethodInvocation = this.accessorMethodInvocation;
                    result = result * PRIME + ($accessorMethodInvocation == null ? 43 : $accessorMethodInvocation.hashCode());
                    return result;
                }
            }
            ...
            protected static class FieldSetterDelegation extends DelegationRecord {
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof Implementation.Context.Default.FieldSetterDelegation)) return false;
                    final Implementation.Context.Default.FieldSetterDelegation other = (Implementation.Context.Default.FieldSetterDelegation) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    if (!super.equals(o)) return false;
                    final java.lang.Object this$fieldDescription = this.fieldDescription;
                    final java.lang.Object other$fieldDescription = other.fieldDescription;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof Implementation.Context.Default.FieldSetterDelegation;
                }
            ...
            /**
             * A factory for creating a {@link Implementation.Context.Default}.
             */
