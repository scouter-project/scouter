 ...
 * rebased class definition as by {@link scouter.bytebuddy.ByteBuddy#rebase(Class)} which copies the original method
 * implementations to additional methods. Furthermore, even the {@link scouter.bytebuddy.ByteBuddy#redefine(Class)}
...
public class ClassReloadingStrategy implements ClassLoadingStrategy<ClassLoader> {
    ...
    /**
     * <p>
     * Obtains a {@link scouter.bytebuddy.dynamic.loading.ClassReloadingStrategy} from an installed Byte Buddy agent. This
    ...
    public enum Strategy {
         ...
         * the {@link scouter.bytebuddy.dynamic.loading.ClassReloadingStrategy#instrumentation} object.
         * </p>
         * <p>
