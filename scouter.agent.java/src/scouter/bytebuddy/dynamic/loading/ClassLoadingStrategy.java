...
public interface ClassLoadingStrategy<T extends ClassLoader> {
    ...
    enum Default implements Configurable<ClassLoader> {
        /**
         * This strategy creates a new {@link ByteArrayClassLoader} with the given
         ...
         * {@link ClassInjector.UsingReflection}. Note that this strategy usually yields
        ...
        protected static class InjectionDispatcher implements ClassLoadingStrategy.Configurable<ClassLoader> {
            ...
            public boolean equals(final java.lang.Object o) {
                ...
                if (!(o instanceof ClassLoadingStrategy.Default.InjectionDispatcher)) return false;
                final ClassLoadingStrategy.Default.InjectionDispatcher other = (ClassLoadingStrategy.Default.InjectionDispatcher) o;
            ...
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof ClassLoadingStrategy.Default.InjectionDispatcher;
            }
        ...
        protected static class WrappingDispatcher implements ClassLoadingStrategy.Configurable<ClassLoader> {
            ...
            protected WrappingDispatcher(ByteArrayClassLoader.PersistenceHandler persistenceHandler, boolean childFirst) {
                this(NO_PROTECTION_DOMAIN, PackageDefinitionStrategy.Trivial.INSTANCE, persistenceHandler, childFirst, DEFAULT_FORBID_EXISTING);
            }
            ...
            @Override
            public Map<TypeDescription, Class<?>> load(ClassLoader classLoader, Map<TypeDescription, byte[]> types) {
                return ByteArrayClassLoader.load(classLoader, types, protectionDomain, persistenceHandler, packageDefinitionStrategy, childFirst, forbidExisting);
            }
            ...
            public boolean equals(final java.lang.Object o) {
                if (o == this) return true;
                if (!(o instanceof ClassLoadingStrategy.Default.WrappingDispatcher)) return false;
                final ClassLoadingStrategy.Default.WrappingDispatcher other = (ClassLoadingStrategy.Default.WrappingDispatcher) o;
                if (!other.canEqual((java.lang.Object) this)) return false;
                final java.lang.Object this$protectionDomain = this.protectionDomain;
                final java.lang.Object other$protectionDomain = other.protectionDomain;
                if (this$protectionDomain == null ? other$protectionDomain != null : !this$protectionDomain.equals(other$protectionDomain)) return false;
                final java.lang.Object this$persistenceHandler = this.persistenceHandler;
                final java.lang.Object other$persistenceHandler = other.persistenceHandler;
                if (this$persistenceHandler == null ? other$persistenceHandler != null : !this$persistenceHandler.equals(other$persistenceHandler)) return false;
                final java.lang.Object this$packageDefinitionStrategy = this.packageDefinitionStrategy;
                final java.lang.Object other$packageDefinitionStrategy = other.packageDefinitionStrategy;
                if (this$packageDefinitionStrategy == null ? other$packageDefinitionStrategy != null : !this$packageDefinitionStrategy.equals(other$packageDefinitionStrategy)) return false;
                if (this.childFirst != other.childFirst) return false;
                if (this.forbidExisting != other.forbidExisting) return false;
                return true;
            }
            ...
            @javax.annotation.Generated("lombok")
            protected boolean canEqual(final java.lang.Object other) {
                return other instanceof ClassLoadingStrategy.Default.WrappingDispatcher;
            }
            ...
            public int hashCode() {
                ...
                final java.lang.Object $protectionDomain = this.protectionDomain;
                result = result * PRIME + ($protectionDomain == null ? 43 : $protectionDomain.hashCode());
                final java.lang.Object $persistenceHandler = this.persistenceHandler;
                result = result * PRIME + ($persistenceHandler == null ? 43 : $persistenceHandler.hashCode());
                final java.lang.Object $packageDefinitionStrategy = this.packageDefinitionStrategy;
                result = result * PRIME + ($packageDefinitionStrategy == null ? 43 : $packageDefinitionStrategy.hashCode());
                result = result * PRIME + (this.childFirst ? 79 : 97);
                result = result * PRIME + (this.forbidExisting ? 79 : 97);
                return result;
            }
        }
    ...
    class ForBootstrapInjection implements ClassLoadingStrategy<ClassLoader> {
        ...
        public boolean equals(final java.lang.Object o) {
            if (o == this) return true;
            if (!(o instanceof ClassLoadingStrategy.ForBootstrapInjection)) return false;
            final ClassLoadingStrategy.ForBootstrapInjection other = (ClassLoadingStrategy.ForBootstrapInjection) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
        ...
        @javax.annotation.Generated("lombok")
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof ClassLoadingStrategy.ForBootstrapInjection;
        }
    ...
    class ForUnsafeInjection implements ClassLoadingStrategy<ClassLoader> {
        ...
        public boolean equals(final java.lang.Object o) {
            if (o == this) return true;
            if (!(o instanceof ClassLoadingStrategy.ForUnsafeInjection)) return false;
            final ClassLoadingStrategy.ForUnsafeInjection other = (ClassLoadingStrategy.ForUnsafeInjection) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
            final java.lang.Object this$protectionDomain = this.protectionDomain;
            final java.lang.Object other$protectionDomain = other.protectionDomain;
            if (this$protectionDomain == null ? other$protectionDomain != null : !this$protectionDomain.equals(other$protectionDomain)) return false;
        ...
        @javax.annotation.Generated("lombok")
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof ClassLoadingStrategy.ForUnsafeInjection;
        }
