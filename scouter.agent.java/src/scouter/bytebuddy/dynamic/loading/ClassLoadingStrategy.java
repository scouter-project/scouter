...
public interface ClassLoadingStrategy<T extends ClassLoader> {
    ...
    enum Default implements Configurable<ClassLoader> {
        ...
        /**
         * This strategy creates a new {@link scouter.bytebuddy.dynamic.loading.ByteArrayClassLoader} with the given
         ...
         * {@link scouter.bytebuddy.dynamic.loading.ClassInjector.UsingReflection}. Note that this strategy usually yields
