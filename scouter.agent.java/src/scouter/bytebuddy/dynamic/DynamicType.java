...
import scouter.bytebuddy.dynamic.loading.InjectionClassLoader;
 ...
 * {@link scouter.bytebuddy.dynamic.DynamicType.Builder} or as the result of an
 * {@link scouter.bytebuddy.implementation.auxiliary.AuxiliaryType}.
 * <p>&nbsp;</p>
...
public interface DynamicType {
    ...
    interface Builder<T> {
        ...
        /**
         * Applies the supplied {@link AsmVisitorWrapper} onto the {@link scouter.bytebuddy.jar.asm.ClassVisitor} during building a dynamic type.
         ...
         * using the {@link scouter.bytebuddy.matcher.ElementMatchers#isTypeInitializer()} matcher.
         * </p>
         *
         ...
         *
         * @param symbol The type variable's symbol.
         * @param bound  The type variable's upper bounds. Can also be {@link scouter.bytebuddy.dynamic.TargetType} if the bound type
         ...
         *
         * @param symbol The type variable's symbol.
         * @param bounds The type variable's upper bounds. Can also be {@link scouter.bytebuddy.dynamic.TargetType} if the bound type
         *               should be equal to the currently instrumented type.
         * @return A new builder that is equal to this builder but with the given type variable defined for the instrumented type.
         */
         ...
         * @param type                The type of the field. Can also be {@link scouter.bytebuddy.dynamic.TargetType} if the field type
         *                            should be equal to the currently instrumented type.
         ...
         * {@link scouter.bytebuddy.implementation.attribute.AnnotationRetention#ENABLED}. If any existing annotations should be
         ...
         * @param returnType          The method's return type. Can also be {@link scouter.bytebuddy.dynamic.TargetType} if the return type
         *                            should be equal to the currently instrumented type.
        ...
        interface MethodDefinition<S> extends Builder<S> {
            ...
            interface ImplementationDefinition<U> {
                 ...
                 * value must be supplied in its unloaded state, i.e. enumerations as {@link scouter.bytebuddy.description.enumeration.EnumerationDescription},
            ...
            interface TypeVariableDefinition<U> extends ImplementationDefinition<U> {
                 ...
                 *
                 * @param symbol The symbol of the type variable.
                 * @param bound  The bounds of the type variables. Can also be {@link scouter.bytebuddy.dynamic.TargetType} for any type
                 ...
                 *
                 * @param symbol The symbol of the type variable.
                 * @param bounds The bounds of the type variables. Can also be {@link scouter.bytebuddy.dynamic.TargetType} for any type
                 *               if a bound type should be equal to the currently instrumented type.
                 * @return A new builder that is equal to the current builder but where the currently defined method declares the specified type variable.
                 */
            ...
            interface ParameterDefinition<U> extends ExceptionDefinition<U> {
                 ...
                 *
                 * @param type                The parameter's type. Can also be {@link scouter.bytebuddy.dynamic.TargetType} if the parameter type
                 *                            should be equal to the currently instrumented type.
                ...
                interface Initial<V> extends ParameterDefinition<V>, Simple<V> {
                     ...
                     *
                     * @param type The parameter types. Any type can also be {@link scouter.bytebuddy.dynamic.TargetType} if the parameter type
                     *             should be equal to the currently instrumented type.
                     ...
                     * Defines the specified parameters for the currently defined method.
                     *
                     * @param types The parameter types. Any type can also be {@link scouter.bytebuddy.dynamic.TargetType} if the parameter type
                     *              should be equal to the currently instrumented type.
                     * @return A new builder that is equal to the current builder but where the currently defined method appends the specified parameters.
                     */
    ...
    interface Unloaded<T> extends DynamicType {
         ...
         * @return This dynamic type in its loaded state.
         * @see scouter.bytebuddy.dynamic.loading.ClassLoadingStrategy.Default
         */
