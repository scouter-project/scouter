 ...
 * {@link DynamicType.Builder} or as the result of an
 * {@link AuxiliaryType}.
 * <p>&nbsp;</p>
...
public interface DynamicType {
    ...
    interface Builder<T> {
        /**
         * Applies the supplied {@link AsmVisitorWrapper} onto the {@link ClassVisitor} during building a dynamic type.
         ...
         *
         * @param symbol The type variable's symbol.
         * @param bound  The type variable's upper bounds. Can also be {@link TargetType} if the bound type
         ...
         *
         * @param symbol The type variable's symbol.
         * @param bounds The type variable's upper bounds. Can also be {@link TargetType} if the bound type
         * should be equal to the currently instrumented type.
         * @return A new builder that is equal to this builder but with the given type variable defined for the instrumented type.
         */
         ...
         * @param type                The type of the field. Can also be {@link TargetType} if the field type
         * should be equal to the currently instrumented type.
         ...
         * {@link AnnotationRetention#ENABLED}. If any existing annotations should be
         ...
         * @param returnType          The method's return type. Can also be {@link TargetType} if the return type
         * should be equal to the currently instrumented type.
            ...
            interface Optional<U> extends FieldDefinition<U>, Builder<U> {
                ...
                interface Valuable<V> extends FieldDefinition.Valuable<V>, Optional<V> {
                    ...
                    abstract class AbstractBase<U> extends Optional.AbstractBase<U> implements Optional.Valuable<U> {
                         ...
                         * @param <V> A loaded type that the built type is guaranteed to be a subclass of.
                         */
                        protected static abstract class Adapter<V> extends Optional.Valuable.AbstractBase<V> {
                            /**
                            ...
                            public boolean equals(final java.lang.Object o) {
                                ...
                                if (!(o instanceof DynamicType.Builder.FieldDefinition.Optional.Valuable.AbstractBase.Adapter)) return false;
                                final DynamicType.Builder.FieldDefinition.Optional.Valuable.AbstractBase.Adapter<?> other = (DynamicType.Builder.FieldDefinition.Optional.Valuable.AbstractBase.Adapter<?>) o;
                                if (!other.canEqual((java.lang.Object) this)) return false;
                                final java.lang.Object this$fieldAttributeAppenderFactory = this.fieldAttributeAppenderFactory;
                                final java.lang.Object other$fieldAttributeAppenderFactory = other.fieldAttributeAppenderFactory;
                            ...
                            protected boolean canEqual(final java.lang.Object other) {
                                return other instanceof DynamicType.Builder.FieldDefinition.Optional.Valuable.AbstractBase.Adapter;
                            }
                            ...
                            public int hashCode() {
                                final int PRIME = 59;
                                int result = 1;
                                final java.lang.Object $fieldAttributeAppenderFactory = this.fieldAttributeAppenderFactory;
        ...
        interface MethodDefinition<S> extends Builder<S> {
            ...
            interface ImplementationDefinition<U> {
                 ...
                 * value must be supplied in its unloaded state, i.e. enumerations as {@link EnumerationDescription},
            ...
            interface TypeVariableDefinition<U> extends ImplementationDefinition<U> {
                 ...
                 *
                 * @param symbol The symbol of the type variable.
                 * @param bound  The bounds of the type variables. Can also be {@link TargetType} for any type
                 ...
                 *
                 * @param symbol The symbol of the type variable.
                 * @param bounds The bounds of the type variables. Can also be {@link TargetType} for any type
                 * if a bound type should be equal to the currently instrumented type.
                 * @return A new builder that is equal to the current builder but where the currently defined method declares the specified type variable.
                 */
                ...
                interface Annotatable<V> extends TypeVariableDefinition<V> {
                    ...
                    abstract class AbstractBase<W> extends TypeVariableDefinition.AbstractBase<W> implements Annotatable<W> {
                         ...
                         */
                        protected static abstract class Adapter<X> extends TypeVariableDefinition.Annotatable.AbstractBase<X> {
                            @Override
            ...
            interface ParameterDefinition<U> extends ExceptionDefinition<U> {
                 ...
                 *
                 * @param type                The parameter's type. Can also be {@link TargetType} if the parameter type
                 * should be equal to the currently instrumented type.
                ...
                interface Annotatable<V> extends ParameterDefinition<V> {
                    ...
                    abstract class AbstractBase<W> extends ParameterDefinition.AbstractBase<W> implements Annotatable<W> {
                         ...
                         * @param <X> A loaded type that the built type is guaranteed to be a subclass of.
                         */
                        protected static abstract class Adapter<X> extends ParameterDefinition.Annotatable.AbstractBase<X> {
                            @Override
                ...
                interface Simple<V> extends ExceptionDefinition<V> {
                    ...
                    interface Annotatable<V> extends Simple<V> {
                        ...
                        abstract class AbstractBase<W> extends Simple.AbstractBase<W> implements Annotatable<W> {
                             ...
                             * @param <X> A loaded type that the built type is guaranteed to be a subclass of.
                             */
                            protected static abstract class Adapter<X> extends Simple.Annotatable.AbstractBase<X> {
                                @Override
                ...
                interface Initial<V> extends ParameterDefinition<V>, Simple<V> {
                     ...
                     *
                     * @param type The parameter types. Any type can also be {@link TargetType} if the parameter type
                     * should be equal to the currently instrumented type.
                     ...
                     * Defines the specified parameters for the currently defined method.
                     *
                     * @param types The parameter types. Any type can also be {@link TargetType} if the parameter type
                     * should be equal to the currently instrumented type.
                     * @return A new builder that is equal to the current builder but where the currently defined method appends the specified parameters.
                     */
            ...
            abstract class AbstractBase<U> extends Builder.AbstractBase.Delegator<U> implements MethodDefinition<U> {
                 ...
                 * @param <V> A loaded type that the built type is guaranteed to be a subclass of.
                 */
                protected static abstract class Adapter<V> extends MethodDefinition.ReceiverTypeDefinition.AbstractBase<V> {
                    /**
                    ...
                    public boolean equals(final java.lang.Object o) {
                        if (o == this) return true;
                        if (!(o instanceof DynamicType.Builder.MethodDefinition.AbstractBase.Adapter)) return false;
                        final DynamicType.Builder.MethodDefinition.AbstractBase.Adapter<?> other = (DynamicType.Builder.MethodDefinition.AbstractBase.Adapter<?>) o;
                        if (!other.canEqual((java.lang.Object) this)) return false;
                    ...
                    @javax.annotation.Generated("lombok")
                    protected boolean canEqual(final java.lang.Object other) {
                        return other instanceof DynamicType.Builder.MethodDefinition.AbstractBase.Adapter;
                    }
        ...
        abstract class AbstractBase<S> implements Builder<S> {
            ...
            public static abstract class Adapter<U> extends AbstractBase<U> {
                ...
                @SuppressWarnings("unchecked")
                public Builder<U> ignoreAlso(LatentMatcher<? super MethodDescription> ignoredMethods) {
                    return materialize(instrumentedType, fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, new LatentMatcher.Disjunction<MethodDescription>(this.ignoredMethods, ignoredMethods));
                }

                @Override
                public Builder<U> initializer(ByteCodeAppender byteCodeAppender) {
                    return materialize(instrumentedType.withInitializer(byteCodeAppender), fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }

                @Override
                public Builder<U> initializer(LoadedTypeInitializer loadedTypeInitializer) {
                    return materialize(instrumentedType.withInitializer(loadedTypeInitializer), fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }

                @Override
                public Builder<U> name(String name) {
                    return materialize(instrumentedType.withName(name), fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }

                @Override
                public Builder<U> modifiers(int modifiers) {
                    return materialize(instrumentedType.withModifiers(modifiers), fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }

                @Override
                public Builder<U> merge(Collection<? extends ModifierContributor.ForType> modifierContributors) {
                    return materialize(instrumentedType.withModifiers(ModifierContributor.Resolver.of(modifierContributors).resolve(instrumentedType.getModifiers())), fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }
                ...
                @Override
                public Builder<U> transform(ElementMatcher<? super TypeDescription.Generic> matcher, Transformer<TypeVariableToken> transformer) {
                    return materialize(instrumentedType.withTypeVariables(matcher, transformer), fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }

                @Override
                public Builder<U> attribute(TypeAttributeAppender typeAttributeAppender) {
                    return materialize(instrumentedType, fieldRegistry, methodRegistry, new TypeAttributeAppender.Compound(this.typeAttributeAppender, typeAttributeAppender), asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }

                @Override
                public Builder<U> annotateType(Collection<? extends AnnotationDescription> annotations) {
                    return materialize(instrumentedType.withAnnotations(new ArrayList<AnnotationDescription>(annotations)), fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }

                @Override
                public Builder<U> visit(AsmVisitorWrapper asmVisitorWrapper) {
                    return materialize(instrumentedType, fieldRegistry, methodRegistry, typeAttributeAppender, new AsmVisitorWrapper.Compound(this.asmVisitorWrapper, asmVisitorWrapper), classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                }
                ...
                protected class TypeVariableDefinitionAdapter extends TypeVariableDefinition.AbstractBase<U> {
                    ...
                    public boolean equals(Object other) {
                        return this == other || !(other == null || getClass() != other.getClass()) && getOuter().equals(((TypeVariableDefinitionAdapter) other).getOuter()) && token.equals(((TypeVariableDefinitionAdapter) other).token);
                    }
                ...
                protected class FieldDefinitionAdapter extends FieldDefinition.Optional.Valuable.AbstractBase.Adapter<U> {
                    ...
                    @Override
                    protected Optional<U> materialize(FieldAttributeAppender.Factory fieldAttributeAppenderFactory, Transformer<FieldDescription> transformer, Object defaultValue) {
                    ...
                    @SuppressWarnings("unchecked")
                    public boolean equals(Object other) {
                        return this == other || !(other == null || getClass() != other.getClass()) && super.equals(other) && getOuter().equals(((FieldDefinitionAdapter) other).getOuter()) && token.equals(((FieldDefinitionAdapter) other).token);
                    }
                ...
                protected class FieldMatchAdapter extends FieldDefinition.Optional.Valuable.AbstractBase.Adapter<U> {
                    ...
                    @SuppressWarnings("unchecked")
                    public boolean equals(Object other) {
                        return this == other || !(other == null || getClass() != other.getClass()) && super.equals(other) && getOuter().equals(((FieldMatchAdapter) other).getOuter()) && matcher.equals(((FieldMatchAdapter) other).matcher);
                    }
                ...
                protected class MethodDefinitionAdapter extends MethodDefinition.ParameterDefinition.Initial.AbstractBase<U> {
                    ...
                    @SuppressWarnings("unchecked")
                    public boolean equals(Object other) {
                        return this == other || !(other == null || getClass() != other.getClass()) && token.equals(((MethodDefinitionAdapter) other).token) && getOuter().equals(((MethodDefinitionAdapter) other).getOuter());
                    }
                    ...
                    protected class TypeVariableAnnotationAdapter extends MethodDefinition.TypeVariableDefinition.Annotatable.AbstractBase.Adapter<U> {
                        ...
                        @SuppressWarnings("unchecked")
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && token.equals(((TypeVariableAnnotationAdapter) other).token) && getOuter().equals(((TypeVariableAnnotationAdapter) other).getOuter());
                        }
                    ...
                    protected class ParameterAnnotationAdapter extends MethodDefinition.ParameterDefinition.Annotatable.AbstractBase.Adapter<U> {
                        ...
                        @SuppressWarnings("unchecked")
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && token.equals(((ParameterAnnotationAdapter) other).token) && getOuter().equals(((ParameterAnnotationAdapter) other).getOuter());
                        }
                    ...
                    protected class SimpleParameterAnnotationAdapter extends MethodDefinition.ParameterDefinition.Simple.Annotatable.AbstractBase.Adapter<U> {
                        ...
                        @SuppressWarnings("unchecked")
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && token.equals(((SimpleParameterAnnotationAdapter) other).token) && getOuter().equals(((SimpleParameterAnnotationAdapter) other).getOuter());
                        }
                    ...
                    protected class AnnotationAdapter extends MethodDefinition.AbstractBase.Adapter<U> {
                        ...
                        @SuppressWarnings("unchecked")
                        public boolean equals(Object other) {
                            return this == other || !(other == null || getClass() != other.getClass()) && super.equals(other) && getOuter().equals(((AnnotationAdapter) other).getOuter());
                        }
                ...
                protected class MethodMatchAdapter extends MethodDefinition.ImplementationDefinition.AbstractBase<U> {
                    ...
                    @SuppressWarnings("unchecked")
                    public boolean equals(Object other) {
                        return this == other || !(other == null || getClass() != other.getClass()) && matcher.equals(((MethodMatchAdapter) other).matcher) && getOuter().equals(((MethodMatchAdapter) other).getOuter());
                    }
                ...
                protected class OptionalMethodMatchAdapter extends Builder.AbstractBase.Delegator<U> implements MethodDefinition.ImplementationDefinition.Optional<U> {
                    ...
                    @Override
                    protected Builder<U> materialize() {
                        return Adapter.this.materialize(instrumentedType.withInterfaces(interfaces), fieldRegistry, methodRegistry, typeAttributeAppender, asmVisitorWrapper, classFileVersion, auxiliaryTypeNamingStrategy, annotationValueFilterFactory, annotationRetention, implementationContextFactory, methodGraphCompiler, typeValidation, ignoredMethods);
                    }
                    ...
                    private MethodDefinition.ImplementationDefinition<U> interfaceType() {
                        ...
                        return materialize().invokable(isDeclaredBy(ElementMatchers.isInterface().and(elementMatcher)));
                    }
                    ...
                    public boolean equals(Object other) {
                        ...
                        return interfaces.equals(that.interfaces) && getOuter().equals(that.getOuter());
                    }
                ...
                public boolean equals(final java.lang.Object o) {
                    if (o == this) return true;
                    if (!(o instanceof DynamicType.Builder.AbstractBase.Adapter)) return false;
                    final DynamicType.Builder.AbstractBase.Adapter<?> other = (DynamicType.Builder.AbstractBase.Adapter<?>) o;
                    if (!other.canEqual((java.lang.Object) this)) return false;
                    ...
                    final java.lang.Object this$fieldRegistry = this.fieldRegistry;
                    final java.lang.Object other$fieldRegistry = other.fieldRegistry;
                    if (this$fieldRegistry == null ? other$fieldRegistry != null : !this$fieldRegistry.equals(other$fieldRegistry)) return false;
                ...
                @javax.annotation.Generated("lombok")
                protected boolean canEqual(final java.lang.Object other) {
                    return other instanceof DynamicType.Builder.AbstractBase.Adapter;
                }
                ...
                public int hashCode() {
                    ...
                    final java.lang.Object $fieldRegistry = this.fieldRegistry;
                    result = result * PRIME + ($fieldRegistry == null ? 43 : $fieldRegistry.hashCode());
    ...
    interface Unloaded<T> extends DynamicType {
         ...
         * @return This dynamic type in its loaded state.
         * @see ClassLoadingStrategy.Default
         */
    ...
    class Default implements DynamicType {
        ...
        // HE: Remove when Lombok support for shadowed types is added.
        @Override
        public boolean equals(Object other) {
            if (this == other) return true;
            if (other == null || getClass() != other.getClass()) return false;
            Default aDefault = (Default) other;
            return auxiliaryTypes.equals(aDefault.auxiliaryTypes) && Arrays.equals(binaryRepresentation, aDefault.binaryRepresentation) && typeDescription.equals(aDefault.typeDescription) && loadedTypeInitializer.equals(aDefault.loadedTypeInitializer);
        }
        ...
        protected static class Loaded<T> extends Default implements DynamicType.Loaded<T> {
            ...
            @Override
            public boolean equals(Object other) {
                return this == other || !(other == null || getClass() != other.getClass()) && super.equals(other) && loadedTypes.equals(((Default.Loaded) other).loadedTypes);
            }
