...
import scouter.bytebuddy.dynamic.scaffold.inline.MethodRebaseResolver;
import scouter.bytebuddy.dynamic.scaffold.inline.RebaseImplementationTarget;
import scouter.bytebuddy.dynamic.scaffold.subclass.SubclassImplementationTarget;
...
import scouter.bytebuddy.utility.privilege.GetSystemPropertyAction;
import scouter.bytebuddy.jar.asm.*;
import scouter.bytebuddy.jar.asm.commons.ClassRemapper;
import scouter.bytebuddy.jar.asm.commons.SimpleRemapper;
...
public interface TypeWriter<T> {
    ...
    interface FieldPool {
         ...
         *
         * @see scouter.bytebuddy.dynamic.scaffold.TypeWriter.FieldPool
         */
        interface Record {
    ...
    interface MethodPool {
         ...
         *
         * @see scouter.bytebuddy.dynamic.scaffold.TypeWriter.MethodPool
         */
        interface Record {
             ...
             * {@link scouter.bytebuddy.dynamic.scaffold.TypeWriter.MethodPool.Record#apply(ClassVisitor, Implementation.Context, AnnotationValueFilter.Factory)}
    ...
    /**
     * A default implementation of a {@link scouter.bytebuddy.dynamic.scaffold.TypeWriter}.
     *
    ...
    abstract class Default<S> implements TypeWriter<S> {
        ...
        public static class ForInlining<U> extends Default<U> {
            ...
            protected class RedefinitionClassVisitor extends ClassVisitor {
                 ...
                 * {@link scouter.bytebuddy.dynamic.scaffold.TypeWriter.MethodPool}.
                 *
