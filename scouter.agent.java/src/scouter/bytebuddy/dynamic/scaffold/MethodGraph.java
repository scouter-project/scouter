...
import static scouter.bytebuddy.matcher.ElementMatchers.isVirtual;
...
public interface MethodGraph {
    ...
    interface Node {
        ...
        /**
         * Represents a {@link scouter.bytebuddy.dynamic.scaffold.MethodGraph.Node}'s state.
         */
        enum Sort {
    ...
    interface Compiler {
        ...
        class Default<T> extends AbstractBase {
            ...
            /**
             * Implementations are responsible for identifying a representative method for a {@link scouter.bytebuddy.dynamic.scaffold.MethodGraph.Node}
            ...
            protected abstract static class Key<S> {
                 ...
                 * {@link scouter.bytebuddy.dynamic.scaffold.MethodGraph.Compiler.Default.Harmonizer}.
                 *
