 ...
 * {@link scouter.bytebuddy.dynamic.DynamicType.Builder} interface. Byte Buddy's API is expressed by fully immutable
 ...
 * {@link scouter.bytebuddy.agent.builder.AgentBuilder}. The API wraps a {@link ByteBuddy} instance and offers agent-specific
 * configuration opportunities by integrating against the {@link java.lang.instrument.Instrumentation} API.
 * </p>
 *
 * @see scouter.bytebuddy.agent.builder.AgentBuilder
 */
public class ByteBuddy {

    /**
     * The default prefix for the default {@link scouter.bytebuddy.NamingStrategy}.
     */
     ...
     * </p>
     * <p>
     * <b>Note</b>: When a user redefines a class with the purpose of reloading this class using a {@link scouter.bytebuddy.dynamic.loading.ClassReloadingStrategy},
     ...
     * {@link ByteBuddy#with(Implementation.Context.Factory)} to use a {@link scouter.bytebuddy.implementation.Implementation.Context.Disabled.Factory}
    ...
    /**
     * Creates a new configuration where the {@link scouter.bytebuddy.implementation.Implementation.Context} of any created
     ...
     * {@link scouter.bytebuddy.implementation.Implementation.Context.Disabled} factory might be more appropriate.
     *
