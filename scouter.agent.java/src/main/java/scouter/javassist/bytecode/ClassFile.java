...
import scouter.javassist.bytecode.ClassFileWriter;
...
import scouter.javassist.bytecode.SourceFileAttribute;
 ...
 * @see MethodInfo
 * @see ClassFileWriter
 * @see scouter.javassist.CtClass#getClassFile()
 * @see scouter.javassist.ClassPool#makeClass(ClassFile)
 */
public final class ClassFile {
     ...
     * 
     * @see scouter.javassist.bytecode.AccessFlag
     */
