...
public abstract class CtClass {
     ...
     */
    public scouter.javassist.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see scouter.javassist.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see scouter.javassist.bytecode.SignatureAttribute.ClassSignature#encode()
     ...
     *
     * @see scouter.javassist.CtConstructor
     */
     ...
     * are not included.
     *
     * @see scouter.javassist.CtMethod
     */
     ...
     *
     * @see scouter.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see scouter.javassist.CtField.Initializer#byExpr(String)
     * @see scouter.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see scouter.javassist.bytecode.AttributeInfo
     */
